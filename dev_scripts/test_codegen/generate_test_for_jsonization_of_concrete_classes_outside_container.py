    ...
    for our_type in symbol_table.our_types:
        ...
        blocks.append(
            Stripped(
                f"""\
@Test
public void testRoundTrip{cls_name_java}() throws IOException {{
...
{I}final {cls_name_java} anotherInstance = Jsonization.Deserialize.deserialize{cls_name_java}(jsonObject);
