...
public class ValueReferencePair implements IValueReferencePair {
  ...
  public ValueReferencePair(String value, IReference valueId) {
    ...
    this.valueId = Objects.requireNonNull(valueId, "Argument \"valueId\" must be non-null.");
  }
  ...
  private class ValueReferencePairIterable implements Iterable<IClass> {
    ...
    private Stream<IClass> stream() {
      ...
      if (valueId != null) {
        memberStream =
            Stream.concat(memberStream, Stream.<IClass>of(ValueReferencePair.this.valueId));
      }
            ...
            Stream.concat(
                ...
                Stream.concat(
                    ...
                    StreamSupport.stream(
                        ValueReferencePair.this.valueId.descend().spliterator(), false)));
      }
