...
public class AnnotatedRelationshipElement implements IAnnotatedRelationshipElement {
  ...
  public AnnotatedRelationshipElement(IReference first, IReference second) {
  ...
  /**
   * Iterate over {@link AnnotatedRelationshipElement#extensions}, if set, and otherwise return an
   * empty iterator.
   */
  ...
  /**
   * Iterate over {@link AnnotatedRelationshipElement#displayName}, if set, and otherwise return an
   * empty iterator.
   */
  ...
  /**
   * Iterate over {@link AnnotatedRelationshipElement#description}, if set, and otherwise return an
   * empty iterator.
   */
  ...
  /**
   * Iterate over {@link AnnotatedRelationshipElement#supplementalSemanticIds}, if set, and
  ...
  /**
   * Iterate over {@link AnnotatedRelationshipElement#qualifiers}, if set, and otherwise return an
   * empty iterator.
   */
  ...
  /**
   * Iterate over {@link AnnotatedRelationshipElement#embeddedDataSpecifications}, if set, and
   * otherwise return an empty iterator.
   */
  ...
  /**
   * Iterate over {@link AnnotatedRelationshipElement#annotations}, if set, and otherwise return an
   * empty iterator.
   */
  ...
  private class AnnotatedRelationshipElementIterable implements Iterable<IClass> {
    ...
    private Stream<IClass> stream() {
      ...
      if (extensions != null) {
        memberStream =
            Stream.concat(memberStream, AnnotatedRelationshipElement.this.extensions.stream());
      }

      if (displayName != null) {
        memberStream =
            Stream.concat(memberStream, AnnotatedRelationshipElement.this.displayName.stream());
      }

      if (description != null) {
        memberStream =
            Stream.concat(memberStream, AnnotatedRelationshipElement.this.description.stream());
      }

      if (semanticId != null) {
        memberStream =
            Stream.concat(
                memberStream, Stream.<IClass>of(AnnotatedRelationshipElement.this.semanticId));
      }

      if (supplementalSemanticIds != null) {
        memberStream =
            Stream.concat(
                memberStream, AnnotatedRelationshipElement.this.supplementalSemanticIds.stream());
      }

      if (qualifiers != null) {
        memberStream =
            Stream.concat(memberStream, AnnotatedRelationshipElement.this.qualifiers.stream());
      }
      ...
      if (first != null) {
        memberStream =
            Stream.concat(memberStream, Stream.<IClass>of(AnnotatedRelationshipElement.this.first));
      }

      if (second != null) {
        memberStream =
            Stream.concat(
                memberStream, Stream.<IClass>of(AnnotatedRelationshipElement.this.second));
      }

      if (annotations != null) {
        memberStream =
            Stream.concat(memberStream, AnnotatedRelationshipElement.this.annotations.stream());
      }
            ...
            Stream.concat(
                ...
                Stream.concat(
                    ...
                    StreamSupport.stream(
                        AnnotatedRelationshipElement.this.semanticId.descend().spliterator(),
                        false)));
      }
        ...
        memberStream =
            Stream.concat(
                ...
                Stream.concat(
                    ...
                    StreamSupport.stream(
                        AnnotatedRelationshipElement.this.first.descend().spliterator(), false)));
      }
        ...
        memberStream =
            Stream.concat(
                ...
                Stream.concat(
                    ...
                    StreamSupport.stream(
                        AnnotatedRelationshipElement.this.second.descend().spliterator(), false)));
      }
