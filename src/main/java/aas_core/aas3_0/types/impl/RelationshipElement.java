...
public class RelationshipElement implements IRelationshipElement {
  ...
  /**
   * Iterate over {@link RelationshipElement#extensions}, if set, and otherwise return an empty
   * iterator.
   */
  ...
  /**
   * Iterate over {@link RelationshipElement#displayName}, if set, and otherwise return an empty
   * iterator.
   */
  ...
  /**
   * Iterate over {@link RelationshipElement#description}, if set, and otherwise return an empty
   * iterator.
   */
  ...
  /**
   * Iterate over {@link RelationshipElement#supplementalSemanticIds}, if set, and otherwise return
   * an empty iterator.
   */
  ...
  /**
   * Iterate over {@link RelationshipElement#qualifiers}, if set, and otherwise return an empty
   * iterator.
   */
  ...
  /**
   * Iterate over {@link RelationshipElement#embeddedDataSpecifications}, if set, and otherwise
  ...
  private class RelationshipElementIterable implements Iterable<IClass> {
    ...
    private Stream<IClass> stream() {
      ...
      if (extensions != null) {
        memberStream = Stream.concat(memberStream, RelationshipElement.this.extensions.stream());
      }

      if (displayName != null) {
        memberStream = Stream.concat(memberStream, RelationshipElement.this.displayName.stream());
      }

      if (description != null) {
        memberStream = Stream.concat(memberStream, RelationshipElement.this.description.stream());
      }

      if (semanticId != null) {
        memberStream =
            Stream.concat(memberStream, Stream.<IClass>of(RelationshipElement.this.semanticId));
      }

      if (supplementalSemanticIds != null) {
        memberStream =
            Stream.concat(memberStream, RelationshipElement.this.supplementalSemanticIds.stream());
      }

      if (qualifiers != null) {
        memberStream = Stream.concat(memberStream, RelationshipElement.this.qualifiers.stream());
      }

      if (embeddedDataSpecifications != null) {
        memberStream =
            Stream.concat(
                memberStream, RelationshipElement.this.embeddedDataSpecifications.stream());
      }

      if (first != null) {
        memberStream =
            Stream.concat(memberStream, Stream.<IClass>of(RelationshipElement.this.first));
      }

      if (second != null) {
        memberStream =
            Stream.concat(memberStream, Stream.<IClass>of(RelationshipElement.this.second));
      }
            ...
            Stream.concat(
                ...
                Stream.concat(
                    ...
                    StreamSupport.stream(
                        RelationshipElement.this.semanticId.descend().spliterator(), false)));
      }
        ...
        memberStream =
            Stream.concat(
                ...
                Stream.concat(
                    ...
                    StreamSupport.stream(
                        RelationshipElement.this.first.descend().spliterator(), false)));
      }
        ...
        memberStream =
            Stream.concat(
                ...
                Stream.concat(
                    ...
                    StreamSupport.stream(
                        RelationshipElement.this.second.descend().spliterator(), false)));
      }
