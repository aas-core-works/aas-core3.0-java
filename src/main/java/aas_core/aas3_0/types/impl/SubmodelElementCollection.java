...
public class SubmodelElementCollection implements ISubmodelElementCollection {
  ...
  /**
   * Iterate over {@link SubmodelElementCollection#extensions}, if set, and otherwise return an
   * empty iterator.
   */
  ...
  /**
   * Iterate over {@link SubmodelElementCollection#displayName}, if set, and otherwise return an
   * empty iterator.
   */
  ...
  /**
   * Iterate over {@link SubmodelElementCollection#description}, if set, and otherwise return an
   * empty iterator.
   */
  ...
  /**
   * Iterate over {@link SubmodelElementCollection#supplementalSemanticIds}, if set, and otherwise
  ...
  /**
   * Iterate over {@link SubmodelElementCollection#qualifiers}, if set, and otherwise return an
   * empty iterator.
   */
  ...
  /**
   * Iterate over {@link SubmodelElementCollection#embeddedDataSpecifications}, if set, and
  ...
  /**
   * Iterate over {@link SubmodelElementCollection#value}, if set, and otherwise return an empty
   * iterator.
   */
  ...
  private class SubmodelElementCollectionIterable implements Iterable<IClass> {
    ...
    private Stream<IClass> stream() {
      ...
      if (displayName != null) {
        memberStream =
            Stream.concat(memberStream, SubmodelElementCollection.this.displayName.stream());
      }

      if (description != null) {
        memberStream =
            Stream.concat(memberStream, SubmodelElementCollection.this.description.stream());
      }

      if (semanticId != null) {
        memberStream =
            Stream.concat(
                memberStream, Stream.<IClass>of(SubmodelElementCollection.this.semanticId));
      }

      if (supplementalSemanticIds != null) {
        memberStream =
            Stream.concat(
                memberStream, SubmodelElementCollection.this.supplementalSemanticIds.stream());
      }

      if (qualifiers != null) {
        memberStream =
            Stream.concat(memberStream, SubmodelElementCollection.this.qualifiers.stream());
      }

      if (embeddedDataSpecifications != null) {
        memberStream =
            Stream.concat(
                memberStream, SubmodelElementCollection.this.embeddedDataSpecifications.stream());
      }

      if (value != null) {
        memberStream = Stream.concat(memberStream, SubmodelElementCollection.this.value.stream());
      }
            ...
            Stream.concat(
                ...
                Stream.concat(
                    ...
                    StreamSupport.stream(
                        SubmodelElementCollection.this.semanticId.descend().spliterator(), false)));
      }
