...
public class ReferenceElement implements IReferenceElement {
  ...
  /**
   * Iterate over {@link ReferenceElement#extensions}, if set, and otherwise return an empty
   * iterator.
   */
  ...
  /**
   * Iterate over {@link ReferenceElement#displayName}, if set, and otherwise return an empty
   * iterator.
   */
  ...
  /**
   * Iterate over {@link ReferenceElement#description}, if set, and otherwise return an empty
   * iterator.
   */
  ...
  /**
   * Iterate over {@link ReferenceElement#supplementalSemanticIds}, if set, and otherwise return an
   * empty iterator.
   */
  ...
  /**
   * Iterate over {@link ReferenceElement#qualifiers}, if set, and otherwise return an empty
   * iterator.
   */
  ...
  /**
   * Iterate over {@link ReferenceElement#embeddedDataSpecifications}, if set, and otherwise return
   * an empty iterator.
   */
  ...
  private class ReferenceElementIterable implements Iterable<IClass> {
    ...
    private Stream<IClass> stream() {
      ...
      if (extensions != null) {
        memberStream = Stream.concat(memberStream, ReferenceElement.this.extensions.stream());
      }

      if (displayName != null) {
        memberStream = Stream.concat(memberStream, ReferenceElement.this.displayName.stream());
      }

      if (description != null) {
        memberStream = Stream.concat(memberStream, ReferenceElement.this.description.stream());
      }

      if (semanticId != null) {
        memberStream =
            Stream.concat(memberStream, Stream.<IClass>of(ReferenceElement.this.semanticId));
      }

      if (supplementalSemanticIds != null) {
        memberStream =
            Stream.concat(memberStream, ReferenceElement.this.supplementalSemanticIds.stream());
      }

      if (qualifiers != null) {
        memberStream = Stream.concat(memberStream, ReferenceElement.this.qualifiers.stream());
      }

      if (embeddedDataSpecifications != null) {
        memberStream =
            Stream.concat(memberStream, ReferenceElement.this.embeddedDataSpecifications.stream());
      }

      if (value != null) {
        memberStream = Stream.concat(memberStream, Stream.<IClass>of(ReferenceElement.this.value));
      }
            ...
            Stream.concat(
                ...
                Stream.concat(
                    ...
                    StreamSupport.stream(
                        ReferenceElement.this.semanticId.descend().spliterator(), false)));
      }
        ...
        memberStream =
            Stream.concat(
                ...
                Stream.concat(
                    ...
                    StreamSupport.stream(
                        ReferenceElement.this.value.descend().spliterator(), false)));
      }
