...
public class MultiLanguageProperty implements IMultiLanguageProperty {
  ...
  /**
   * Iterate over {@link MultiLanguageProperty#extensions}, if set, and otherwise return an empty
   * iterator.
   */
  ...
  /**
   * Iterate over {@link MultiLanguageProperty#displayName}, if set, and otherwise return an empty
   * iterator.
   */
  ...
  /**
   * Iterate over {@link MultiLanguageProperty#description}, if set, and otherwise return an empty
   * iterator.
   */
  ...
  /**
   * Iterate over {@link MultiLanguageProperty#supplementalSemanticIds}, if set, and otherwise
  ...
  /**
   * Iterate over {@link MultiLanguageProperty#qualifiers}, if set, and otherwise return an empty
   * iterator.
   */
  ...
  /**
   * Iterate over {@link MultiLanguageProperty#embeddedDataSpecifications}, if set, and otherwise
   * return an empty iterator.
   */
  ...
  /**
   * Iterate over {@link MultiLanguageProperty#value}, if set, and otherwise return an empty
   * iterator.
   */
  ...
  private class MultiLanguagePropertyIterable implements Iterable<IClass> {
    ...
    private Stream<IClass> stream() {
      ...
      if (extensions != null) {
        memberStream = Stream.concat(memberStream, MultiLanguageProperty.this.extensions.stream());
      }

      if (displayName != null) {
        memberStream = Stream.concat(memberStream, MultiLanguageProperty.this.displayName.stream());
      }

      if (description != null) {
        memberStream = Stream.concat(memberStream, MultiLanguageProperty.this.description.stream());
      }

      if (semanticId != null) {
        memberStream =
            Stream.concat(memberStream, Stream.<IClass>of(MultiLanguageProperty.this.semanticId));
      }

      if (supplementalSemanticIds != null) {
        memberStream =
            Stream.concat(
                memberStream, MultiLanguageProperty.this.supplementalSemanticIds.stream());
      }

      if (qualifiers != null) {
        memberStream = Stream.concat(memberStream, MultiLanguageProperty.this.qualifiers.stream());
      }

      if (embeddedDataSpecifications != null) {
        memberStream =
            Stream.concat(
                memberStream, MultiLanguageProperty.this.embeddedDataSpecifications.stream());
      }

      if (value != null) {
        memberStream = Stream.concat(memberStream, MultiLanguageProperty.this.value.stream());
      }

      if (valueId != null) {
        memberStream =
            Stream.concat(memberStream, Stream.<IClass>of(MultiLanguageProperty.this.valueId));
      }
            ...
            Stream.concat(
                ...
                Stream.concat(
                    ...
                    StreamSupport.stream(
                        MultiLanguageProperty.this.semanticId.descend().spliterator(), false)));
      }
        ...
        memberStream =
            Stream.concat(
                ...
                Stream.concat(
                    ...
                    StreamSupport.stream(
                        MultiLanguageProperty.this.valueId.descend().spliterator(), false)));
      }
