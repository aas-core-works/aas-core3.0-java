...
public class Reference implements IReference {
  ...
  public Reference(ReferenceTypes type, List<IKey> keys) {
  ...
  public Reference(ReferenceTypes type, List<IKey> keys, IReference referredSemanticId) {
    this.type = Objects.requireNonNull(type, "Argument \"type\" must be non-null.");
    this.keys = Objects.requireNonNull(keys, "Argument \"keys\" must be non-null.");
  ...
  private class ReferenceIterable implements Iterable<IClass> {
    ...
    private Stream<IClass> stream() {
      ...
      if (referredSemanticId != null) {
        memberStream =
            Stream.concat(memberStream, Stream.<IClass>of(Reference.this.referredSemanticId));
      }

      if (keys != null) {
        memberStream = Stream.concat(memberStream, Reference.this.keys.stream());
      }
            ...
            Stream.concat(
                ...
                Stream.concat(
                    ...
                    StreamSupport.stream(
                        Reference.this.referredSemanticId.descend().spliterator(), false)));
      }
