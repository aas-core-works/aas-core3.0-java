...
public class ConceptDescription implements IConceptDescription {
  ...
  /**
   * Iterate over {@link ConceptDescription#extensions}, if set, and otherwise return an empty
   * iterator.
   */
  ...
  /**
   * Iterate over {@link ConceptDescription#displayName}, if set, and otherwise return an empty
   * iterator.
   */
  ...
  /**
   * Iterate over {@link ConceptDescription#description}, if set, and otherwise return an empty
   * iterator.
   */
  ...
  /**
   * Iterate over {@link ConceptDescription#embeddedDataSpecifications}, if set, and otherwise
  ...
  /**
   * Iterate over {@link ConceptDescription#isCaseOf}, if set, and otherwise return an empty
   * iterator.
   */
  ...
  private class ConceptDescriptionIterable implements Iterable<IClass> {
    ...
    private Stream<IClass> stream() {
      ...
      if (extensions != null) {
        memberStream = Stream.concat(memberStream, ConceptDescription.this.extensions.stream());
      }

      if (displayName != null) {
        memberStream = Stream.concat(memberStream, ConceptDescription.this.displayName.stream());
      }

      if (description != null) {
        memberStream = Stream.concat(memberStream, ConceptDescription.this.description.stream());
      }

      if (administration != null) {
        memberStream =
            Stream.concat(memberStream, Stream.<IClass>of(ConceptDescription.this.administration));
      }

      if (embeddedDataSpecifications != null) {
        memberStream =
            Stream.concat(
                memberStream, ConceptDescription.this.embeddedDataSpecifications.stream());
      }

      if (isCaseOf != null) {
        memberStream = Stream.concat(memberStream, ConceptDescription.this.isCaseOf.stream());
      }
            ...
            Stream.concat(
                ...
                Stream.concat(
                    ...
                    StreamSupport.stream(
                        ConceptDescription.this.administration.descend().spliterator(), false)));
      }
