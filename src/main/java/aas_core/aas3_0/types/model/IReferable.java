 ...
 *
 * <p>This ID is not globally unique. This ID is unique within the name space of the element.
 *
 * <p>Constraints:
 *
 * <ul>
 *   <li>Constraint AASd-022: {@link #getIdShort()} of non-identifiable referables within the same
...
public interface IReferable extends IHasExtensions {
   ...
   * #getIdShort()} is typically identical to the short name in English.
   */
