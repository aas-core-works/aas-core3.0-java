...
public class Copying {
   ...
   *
   * <p>All the properties are copied by reference. This includes also the lists. Hence, a list
   * property is copied by reference, and not, as sometimes might be expected, as a new list of
  ...
  private static class ShallowCopier extends AbstractTransformer<IClass> {
    ...
    public IClass transformResource(IResource that) {
      return new Resource(that.getPath(), that.getContentType().orElse(null));
    }
    ...
    public IClass transformReference(IReference that) {
      return new Reference(
          that.getType(), that.getKeys(), that.getReferredSemanticId().orElse(null));
    }
    ...
    public IClass transformEmbeddedDataSpecification(IEmbeddedDataSpecification that) {
      return new EmbeddedDataSpecification(
          that.getDataSpecificationContent(), that.getDataSpecification().orElse(null));
    }

    @Override
    public IClass transformLevelType(ILevelType that) {
      return new LevelType(that.getMin(), that.getNom(), that.getTyp(), that.getMax());
    }
    ...
    public IClass transformLangStringPreferredNameTypeIec61360(
      ...
      return new LangStringPreferredNameTypeIec61360(that.getLanguage(), that.getText());
    }

    @Override
    public IClass transformLangStringShortNameTypeIec61360(ILangStringShortNameTypeIec61360 that) {
      return new LangStringShortNameTypeIec61360(that.getLanguage(), that.getText());
    }

    @Override
    public IClass transformLangStringDefinitionTypeIec61360(
        ILangStringDefinitionTypeIec61360 that) {
      return new LangStringDefinitionTypeIec61360(that.getLanguage(), that.getText());
    }
  ...
  private static class DeepCopier extends AbstractTransformer<IClass> {
    @Override
    public IClass transformExtension(IExtension that) {
      List<IReference> thatSupplementalSemanticIds = that.getSupplementalSemanticIds().orElse(null);
      List<IReference> theSupplementalSemanticIds = null;
      if (thatSupplementalSemanticIds != null) {
        theSupplementalSemanticIds = new ArrayList<>(thatSupplementalSemanticIds.size());
        for (IReference item : thatSupplementalSemanticIds) {
          theSupplementalSemanticIds.add(deep(item));
        }
      }

      List<IReference> thatRefersTo = that.getRefersTo().orElse(null);
      List<IReference> theRefersTo = null;
      if (thatRefersTo != null) {
        theRefersTo = new ArrayList<>(thatRefersTo.size());
    ...
    public IClass transformAdministrativeInformation(IAdministrativeInformation that) {
      ...
      if (thatEmbeddedDataSpecifications != null) {
        theEmbeddedDataSpecifications = new ArrayList<>(thatEmbeddedDataSpecifications.size());
    ...
    @Override
    public IClass transformAssetAdministrationShell(IAssetAdministrationShell that) {
      List<IExtension> thatExtensions = that.getExtensions().orElse(null);
      List<IExtension> theExtensions = null;
      if (thatExtensions != null) {
        theExtensions = new ArrayList<>(thatExtensions.size());
        for (IExtension item : thatExtensions) {
          theExtensions.add(deep(item));
        }
      }

      List<ILangStringNameType> thatDisplayName = that.getDisplayName().orElse(null);
      List<ILangStringNameType> theDisplayName = null;
      if (thatDisplayName != null) {
        theDisplayName = new ArrayList<>(thatDisplayName.size());
        for (ILangStringNameType item : thatDisplayName) {
          theDisplayName.add(deep(item));
        }
      }

      List<ILangStringTextType> thatDescription = that.getDescription().orElse(null);
      List<ILangStringTextType> theDescription = null;
      if (thatDescription != null) {
        theDescription = new ArrayList<>(thatDescription.size());
      ...
      List<IReference> thatSubmodels = that.getSubmodels().orElse(null);
      List<IReference> theSubmodels = null;
      if (thatSubmodels != null) {
        theSubmodels = new ArrayList<>(thatSubmodels.size());
    ...
    @Override
    public IClass transformAssetInformation(IAssetInformation that) {
      List<ISpecificAssetId> thatSpecificAssetIds = that.getSpecificAssetIds().orElse(null);
      List<ISpecificAssetId> theSpecificAssetIds = null;
      if (thatSpecificAssetIds != null) {
        theSpecificAssetIds = new ArrayList<>(thatSpecificAssetIds.size());
    ...
    public IClass transformSubmodel(ISubmodel that) {
      ...
      List<IQualifier> thatQualifiers = that.getQualifiers().orElse(null);
      List<IQualifier> theQualifiers = null;
      if (thatQualifiers != null) {
        theQualifiers = new ArrayList<>(thatQualifiers.size());
      ...
      List<ISubmodelElement> thatSubmodelElements = that.getSubmodelElements().orElse(null);
      List<ISubmodelElement> theSubmodelElements = null;
      if (thatSubmodelElements != null) {
        theSubmodelElements = new ArrayList<>(thatSubmodelElements.size());
    ...
    public IClass transformSubmodelElementList(ISubmodelElementList that) {
      ...
      List<ISubmodelElement> thatValue = that.getValue().orElse(null);
      List<ISubmodelElement> theValue = null;
      if (thatValue != null) {
        theValue = new ArrayList<>(thatValue.size());
    ...
    public IClass transformMultiLanguageProperty(IMultiLanguageProperty that) {
      ...
      List<ILangStringTextType> thatValue = that.getValue().orElse(null);
    ...
    public IClass transformAnnotatedRelationshipElement(IAnnotatedRelationshipElement that) {
      ...
      List<IDataElement> thatAnnotations = that.getAnnotations().orElse(null);
      List<IDataElement> theAnnotations = null;
      if (thatAnnotations != null) {
        theAnnotations = new ArrayList<>(thatAnnotations.size());
    ...
    public IClass transformEntity(IEntity that) {
      ...
      List<ISubmodelElement> thatStatements = that.getStatements().orElse(null);
      List<ISubmodelElement> theStatements = null;
      if (thatStatements != null) {
        theStatements = new ArrayList<>(thatStatements.size());
    ...
    public IClass transformOperation(IOperation that) {
      ...
      List<IOperationVariable> thatInputVariables = that.getInputVariables().orElse(null);
      List<IOperationVariable> theInputVariables = null;
      if (thatInputVariables != null) {
        theInputVariables = new ArrayList<>(thatInputVariables.size());
        for (IOperationVariable item : thatInputVariables) {
          theInputVariables.add(deep(item));
        }
      }

      List<IOperationVariable> thatOutputVariables = that.getOutputVariables().orElse(null);
      List<IOperationVariable> theOutputVariables = null;
      if (thatOutputVariables != null) {
        theOutputVariables = new ArrayList<>(thatOutputVariables.size());
        for (IOperationVariable item : thatOutputVariables) {
          theOutputVariables.add(deep(item));
        }
      }

      List<IOperationVariable> thatInoutputVariables = that.getInoutputVariables().orElse(null);
      List<IOperationVariable> theInoutputVariables = null;
      if (thatInoutputVariables != null) {
        theInoutputVariables = new ArrayList<>(thatInoutputVariables.size());
    ...
    @Override
    public IClass transformOperationVariable(IOperationVariable that) {
      return new OperationVariable(deep(that.getValue()));
    }
    ...
    public IClass transformConceptDescription(IConceptDescription that) {
      ...
      List<IReference> thatIsCaseOf = that.getIsCaseOf().orElse(null);
      List<IReference> theIsCaseOf = null;
      if (thatIsCaseOf != null) {
        theIsCaseOf = new ArrayList<>(thatIsCaseOf.size());
    ...
    @Override
    public IClass transformReference(IReference that) {
      List<IKey> theKeys = new ArrayList<>(that.getKeys().size());
      for (IKey item : that.getKeys()) {
        theKeys.add(deep(item));
      }

      return new Reference(that.getType(), theKeys, that.getReferredSemanticId().orElse(null));
    }
    ...
    public IClass transformEnvironment(IEnvironment that) {
      ...
      if (thatAssetAdministrationShells != null) {
        theAssetAdministrationShells = new ArrayList<>(thatAssetAdministrationShells.size());
        for (IAssetAdministrationShell item : thatAssetAdministrationShells) {
          theAssetAdministrationShells.add(deep(item));
        }
      }

      List<ISubmodel> thatSubmodels = that.getSubmodels().orElse(null);
      ...
      if (thatConceptDescriptions != null) {
        theConceptDescriptions = new ArrayList<>(thatConceptDescriptions.size());
        for (IConceptDescription item : thatConceptDescriptions) {
          theConceptDescriptions.add(deep(item));
        }
      }

      return new Environment(theAssetAdministrationShells, theSubmodels, theConceptDescriptions);
    }

    @Override
    public IClass transformEmbeddedDataSpecification(IEmbeddedDataSpecification that) {
      return new EmbeddedDataSpecification(
          deep(that.getDataSpecificationContent()), that.getDataSpecification().orElse(null));
    }
    ...
    @Override
    public IClass transformValueReferencePair(IValueReferencePair that) {
      return new ValueReferencePair(that.getValue(), deep(that.getValueId()));
    }

    @Override
    public IClass transformValueList(IValueList that) {
      List<IValueReferencePair> theValueReferencePairs =
          new ArrayList<>(that.getValueReferencePairs().size());
      for (IValueReferencePair item : that.getValueReferencePairs()) {
        theValueReferencePairs.add(deep(item));
      }

      return new ValueList(theValueReferencePairs);
    }
    ...
    @Override
    public IClass transformDataSpecificationIec61360(IDataSpecificationIec61360 that) {
      List<ILangStringPreferredNameTypeIec61360> thePreferredName =
          new ArrayList<>(that.getPreferredName().size());
      for (ILangStringPreferredNameTypeIec61360 item : that.getPreferredName()) {
        thePreferredName.add(deep(item));
      }

      List<ILangStringShortNameTypeIec61360> thatShortName = that.getShortName().orElse(null);
      List<ILangStringShortNameTypeIec61360> theShortName = null;
      if (thatShortName != null) {
        theShortName = new ArrayList<>(thatShortName.size());
        for (ILangStringShortNameTypeIec61360 item : thatShortName) {
          theShortName.add(deep(item));
        }
      }

      List<ILangStringDefinitionTypeIec61360> thatDefinition = that.getDefinition().orElse(null);
      List<ILangStringDefinitionTypeIec61360> theDefinition = null;
      if (thatDefinition != null) {
        theDefinition = new ArrayList<>(thatDefinition.size());
