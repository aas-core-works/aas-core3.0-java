...
/**
 * Define the interface for a transformer which transforms recursively the instances into something
 * else.
 *
 * <p>When you use the transformer, please always call the main dispatching method {@link
 * ITransformer#transform}. You should most probably never call the {@code transform} methods
