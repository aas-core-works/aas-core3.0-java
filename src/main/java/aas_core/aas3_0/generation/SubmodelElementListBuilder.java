...
public class SubmodelElementListBuilder {
  ...
  /**
   * Defines whether order in list is relevant. If {@link
   * aas_core.aas3_0.types.impl.SubmodelElementList#getOrderRelevant()} = {@code False} then the
   * list is representing a set or a bag.
   *
   * <p>Default: {@code True}
   */
  ...
  public SubmodelElementListBuilder(AasSubmodelElements typeValueListElement) {
    this.typeValueListElement =
        Objects.requireNonNull(
            typeValueListElement, "Argument \"typeValueListElement\" must be non-null.");
  }
  ...
  public SubmodelElementListBuilder setSupplementalSemanticIds(
  ...
  public SubmodelElementListBuilder setEmbeddedDataSpecifications(
