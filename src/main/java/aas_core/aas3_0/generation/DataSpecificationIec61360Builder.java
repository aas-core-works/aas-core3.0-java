...
public class DataSpecificationIec61360Builder {
   ...
   *
   * <ul>
   *   <li>Constraint AASc-3a-002: {@link
   *       aas_core.aas3_0.types.impl.DataSpecificationIec61360#getPreferredName()} shall be
   *       provided at least in English.
   * </ul>
   */
   ...
   * Unique unit id
   *
   * <p>{@link aas_core.aas3_0.types.impl.DataSpecificationIec61360#getUnit()} and {@link
   * aas_core.aas3_0.types.impl.DataSpecificationIec61360#getUnitId()} need to be consistent if both
   * attributes are set
   *
  ...
  public DataSpecificationIec61360Builder setDefinition(
