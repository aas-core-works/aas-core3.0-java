...
public class AnnotatedRelationshipElementBuilder {
  ...
  public AnnotatedRelationshipElementBuilder(IReference first, IReference second) {
    this.first = Objects.requireNonNull(first, "Argument \"first\" must be non-null.");
    this.second = Objects.requireNonNull(second, "Argument \"second\" must be non-null.");
  }
