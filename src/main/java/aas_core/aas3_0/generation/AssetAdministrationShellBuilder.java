...
public class AssetAdministrationShellBuilder {
  ...
  public AssetAdministrationShellBuilder(String id, IAssetInformation assetInformation) {
  ...
  public AssetAdministrationShellBuilder setAdministration(
      IAdministrativeInformation administration) {
    this.administration = administration;
    return this;
  }

  public AssetAdministrationShellBuilder setEmbeddedDataSpecifications(
