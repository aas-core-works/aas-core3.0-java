...
public class Xmlization {
  ...
  public static final String AAS_NAME_SPACE = "https://admin-shell.io/aas/3/0";
   ...
   *
   * <p>The implementation propagates an {@link Reporting.Error} instead of relying on exceptions.
   * Under the assumption that incorrect data is much less frequent than correct data, this makes
   * the deserialization more efficient.
   *
   * <p>However, we do not want to force the client to deal with the {@link Reporting.Error} class
   * as this is not intuitive. Therefore we distinguish the implementation, realized in {@link
   * DeserializeImplementation}, and the facade given in {@link Deserialize} class.
   */
  private static class DeserializeImplementation {
    private static XMLEvent currentEvent(XMLEventReader reader) {
      try {
        ...
        throw new Xmlization.DeserializeException(
            "", "Failed in method peek because of: " + xmlStreamException.getMessage());
      }
    }
    ...
    private static boolean isEmptyElement(XMLEventReader reader) {
      ...
      try {
        ...
        throw new Xmlization.DeserializeException(
            "", "Failed in method isEmptyElement because of: " + xmlStreamException.getMessage());
      }
      return currentEvent(reader).isEndElement();
    }

    private static boolean isWrongClosingTag(
        Result<String> tryElementName, Result<String> tryEndElementName) {
    ...
    private static Result<XMLEvent> verifyClosingTagForClass(
        String className, XMLEventReader reader, Result<String> tryElementName) {
      final XMLEvent currentEvent = currentEvent(reader);
      if (currentEvent.isEndDocument()) {
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an XML end element to conclude a property of class "
                    + className
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an XML end element to conclude a property of class "
                    ...
                    + tryElementName.getResult()
                    + ", "
                    + "but got the node of type "
                    + getEventTypeAsString(currentEvent)
                    + " with the value "
                    + currentEvent);
        return Result.failure(error);
      }
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an XML end element to conclude a property of class "
                    ...
                    + tryElementName.getResult()
                    + ", "
                    + "but got the end element with the name "
                    + tryEndElementName.getResult());
        return Result.failure(error);
      }
      try {
    ...
    private static boolean whiteSpaceOrComment(XMLEventReader reader) {
      ...
      final boolean isComment =
          (currentEvent != null && currentEvent.getEventType() == XMLStreamConstants.COMMENT);
    ...
    private static byte[] readContentAsBase64(XMLEventReader reader) throws XMLStreamException {
      final StringBuilder content = new StringBuilder();
      while (reader.peek().isCharacters()
          || reader.peek().getEventType() == XMLStreamConstants.COMMENT) {
        if (reader.peek().isCharacters()) {
      ...
      try {
        ...
        throw new XMLStreamException(
            "Failed to read base64 encoded data: " + exception.getMessage());
      }
    ...
    private static Result<? extends IHasSemantics> tryIHasSemanticsFromElement(
      ...
      if (currentEvent.getEventType() == XMLStreamConstants.END_DOCUMENT) {
        final Reporting.Error error =
            new Reporting.Error("Expected an XML element, but reached end-of-file");
        return Result.failure(error);
      }
      ...
      Result<String> tryElementName = tryElementName(reader);
     ...
     *
     * <p>If {@code isEmptySequence} is set, we should try to deserialize the instance from an empty
     * sequence. That is, the parent element was a self-closing element.
     */
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
          ...
          switch (tryElementName.getResult()) {
            case "semanticId":
              {
                Result<Reference> trySemanticId = tryReferenceFromSequence(reader, isEmptyProperty);

                if (trySemanticId.isError()) {
                  trySemanticId.getError().prependSegment(new Reporting.NameSegment("semanticId"));
                ...
                if (!isEmptyProperty) {
                  ...
                  while (currentEvent(reader).isStartElement()) {
                    ...
                    if (itemResult.isError()) {
                      itemResult.getError().prependSegment(new Reporting.IndexSegment(index));
                      itemResult
                          .getError()
                          .prependSegment(new Reporting.NameSegment("supplementalSemanticIds"));
            ...
            case "valueType":
              {
                if (isEmptyProperty) {
                  ...
                  error.prependSegment(new Reporting.NameSegment("valueType"));
                  return Result.failure(error);
                }
                ...
                final Optional<DataTypeDefXsd> optionalValueType =
                    Stringification.dataTypeDefXsdFromString(textValueType);
            ...
            case "refersTo":
              {
                ...
                if (!isEmptyProperty) {
                  ...
                  while (currentEvent(reader).isStartElement()) {
                    ...
                    if (itemResult.isError()) {
                      itemResult.getError().prependSegment(new Reporting.IndexSegment(index));
                      itemResult.getError().prependSegment(new Reporting.NameSegment("refersTo"));
                      return itemResult.castTo(Extension.class);
                    }
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("Extension", reader, tryElementName);
    ...
    private static Result<Extension> tryExtensionFromElement(XMLEventReader reader) {
      skipWhitespaceAndComments(reader);
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class Extension "
                    + "with element name extension, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<Extension> result = tryExtensionFromSequence(reader, isEmptyElement);
    ...
    private static Result<? extends IReferable> tryIReferableFromElement(XMLEventReader reader) {
      skipWhitespaceAndComments(reader);
    ...
    private static Result<? extends IHasKind> tryIHasKindFromElement(XMLEventReader reader) {
      skipWhitespaceAndComments(reader);
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
          ...
          switch (tryElementName.getResult()) {
            case "embeddedDataSpecifications":
              {
                ...
                if (!isEmptyProperty) {
                  ...
                  while (currentEvent(reader).isStartElement()) {
                    ...
                    Result<? extends IEmbeddedDataSpecification> itemResult =
                        tryEmbeddedDataSpecificationFromElement(reader);

                    if (itemResult.isError()) {
                      itemResult.getError().prependSegment(new Reporting.IndexSegment(index));
                      itemResult
                          .getError()
                          .prependSegment(new Reporting.NameSegment("embeddedDataSpecifications"));
                    ...
                    final Reporting.Error error =
                        new Reporting.Error(
                            "The property version of an instance of class AdministrativeInformation "
                                + " could not be de-serialized: "
                                + e.getMessage());
                    error.prependSegment(new Reporting.NameSegment("version"));
                    return Result.failure(error);
                  }
                }
                break;
                    ...
                    final Reporting.Error error =
                        new Reporting.Error(
                            "The property revision of an instance of class AdministrativeInformation "
                                + " could not be de-serialized: "
                                + e.getMessage());
                    error.prependSegment(new Reporting.NameSegment("revision"));
                    return Result.failure(error);
                  }
                }
                break;
            ...
            case "creator":
              {
                Result<Reference> tryCreator = tryReferenceFromSequence(reader, isEmptyProperty);

                if (tryCreator.isError()) {
                  tryCreator.getError().prependSegment(new Reporting.NameSegment("creator"));
                    ...
                    final Reporting.Error error =
                        new Reporting.Error(
                            "The property templateId of an instance of class AdministrativeInformation "
                                + " could not be de-serialized: "
                                + e.getMessage());
                    error.prependSegment(new Reporting.NameSegment("templateId"));
                    return Result.failure(error);
                  }
                }
                break;
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("AdministrativeInformation", reader, tryElementName);
          if (checkEndElement.isError())
            return checkEndElement.castTo(AdministrativeInformation.class);
        }
      }

      return Result.success(
          new AdministrativeInformation(
              theEmbeddedDataSpecifications, theVersion, theRevision, theCreator, theTemplateId));
    }
    ...
    private static Result<AdministrativeInformation> tryAdministrativeInformationFromElement(
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class AdministrativeInformation "
                    + "with element name administrativeInformation, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<AdministrativeInformation> result =
          tryAdministrativeInformationFromSequence(reader, isEmptyElement);
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
          ...
          switch (tryElementName.getResult()) {
            ...
            case "kind":
              {
                  ...
                  final Reporting.Error error =
                      new Reporting.Error(
                          "The property kind of an instance of class Qualifier "
                              + "can not be de-serialized from a self-closing element "
                              + "since it needs content");
                  error.prependSegment(new Reporting.NameSegment("kind"));
                  return Result.failure(error);
                }
                ...
                final Optional<QualifierKind> optionalKind =
                    Stringification.qualifierKindFromString(textKind);
                    ...
                    final Reporting.Error error =
                        new Reporting.Error(
                            "The property type of an instance of class Qualifier "
                                + " could not be de-serialized: "
                                + e.getMessage());
                    error.prependSegment(new Reporting.NameSegment("type"));
                    return Result.failure(error);
                  }
                }
                break;
            ...
            case "valueId":
              {
                Result<Reference> tryValueId = tryReferenceFromSequence(reader, isEmptyProperty);

                if (tryValueId.isError()) {
                  tryValueId.getError().prependSegment(new Reporting.NameSegment("valueId"));
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("Qualifier", reader, tryElementName);
    ...
    private static Result<Qualifier> tryQualifierFromElement(XMLEventReader reader) {
      skipWhitespaceAndComments(reader);
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class Qualifier "
                    + "with element name qualifier, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<Qualifier> result = tryQualifierFromSequence(reader, isEmptyElement);
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
          ...
          switch (tryElementName.getResult()) {
            case "extensions":
              {
                ...
                if (!isEmptyProperty) {
                  ...
                  while (currentEvent(reader).isStartElement()) {
                    ...
                    if (itemResult.isError()) {
                      itemResult.getError().prependSegment(new Reporting.IndexSegment(index));
                      itemResult.getError().prependSegment(new Reporting.NameSegment("extensions"));
                    ...
                    final Reporting.Error error =
                        new Reporting.Error(
                            "The property category of an instance of class AssetAdministrationShell "
                                + " could not be de-serialized: "
                                + e.getMessage());
                    error.prependSegment(new Reporting.NameSegment("category"));
                    return Result.failure(error);
                  }
                }
                break;
            ...
            case "displayName":
              {
                ...
                if (!isEmptyProperty) {
                  ...
                  while (currentEvent(reader).isStartElement()) {
                    ...
                    Result<? extends ILangStringNameType> itemResult =
                        tryLangStringNameTypeFromElement(reader);

                    if (itemResult.isError()) {
                      itemResult.getError().prependSegment(new Reporting.IndexSegment(index));
                      itemResult
                          .getError()
                          .prependSegment(new Reporting.NameSegment("displayName"));
                      return itemResult.castTo(AssetAdministrationShell.class);
                    }
            ...
            case "description":
              {
                ...
                if (!isEmptyProperty) {
                  ...
                  while (currentEvent(reader).isStartElement()) {
                    ...
                    Result<? extends ILangStringTextType> itemResult =
                        tryLangStringTextTypeFromElement(reader);
            ...
            case "administration":
              {
                Result<AdministrativeInformation> tryAdministration =
                    tryAdministrativeInformationFromSequence(reader, isEmptyProperty);
            ...
            case "derivedFrom":
              {
                Result<Reference> tryDerivedFrom =
            ...
            case "assetInformation":
              {
                Result<AssetInformation> tryAssetInformation =
                    tryAssetInformationFromSequence(reader, isEmptyProperty);
            ...
            case "submodels":
              {
                ...
                if (!isEmptyProperty) {
                  ...
                  while (currentEvent(reader).isStartElement()) {
                    ...
                    if (itemResult.isError()) {
                      itemResult.getError().prependSegment(new Reporting.IndexSegment(index));
                      itemResult.getError().prependSegment(new Reporting.NameSegment("submodels"));
                      return itemResult.castTo(AssetAdministrationShell.class);
                    }
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("AssetAdministrationShell", reader, tryElementName);
          if (checkEndElement.isError())
            return checkEndElement.castTo(AssetAdministrationShell.class);
        }
      }
    ...
    private static Result<AssetAdministrationShell> tryAssetAdministrationShellFromElement(
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class AssetAdministrationShell "
                    + "with element name assetAdministrationShell, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<AssetAdministrationShell> result =
          tryAssetAdministrationShellFromSequence(reader, isEmptyElement);
        ...
        while (true) {
          ...
          switch (tryElementName.getResult()) {
            case "assetKind":
              {
                  ...
                  final Reporting.Error error =
                      new Reporting.Error(
                          "The property assetKind of an instance of class AssetInformation "
                              + "can not be de-serialized from a self-closing element "
                              + "since it needs content");
                  error.prependSegment(new Reporting.NameSegment("assetKind"));
                  return Result.failure(error);
                }
                ...
                final Optional<AssetKind> optionalAssetKind =
                    Stringification.assetKindFromString(textAssetKind);
            ...
            case "specificAssetIds":
              {
                ...
                if (!isEmptyProperty) {
                  ...
                  while (currentEvent(reader).isStartElement()) {
                    ...
                    Result<? extends ISpecificAssetId> itemResult =
                        trySpecificAssetIdFromElement(reader);

                    if (itemResult.isError()) {
                      itemResult.getError().prependSegment(new Reporting.IndexSegment(index));
                      itemResult
                          .getError()
                          .prependSegment(new Reporting.NameSegment("specificAssetIds"));
                    ...
                    final Reporting.Error error =
                        new Reporting.Error(
                            "The property assetType of an instance of class AssetInformation "
                                + " could not be de-serialized: "
                                + e.getMessage());
                    error.prependSegment(new Reporting.NameSegment("assetType"));
                    return Result.failure(error);
                  }
                }
                break;
            ...
            case "defaultThumbnail":
              {
                Result<Resource> tryDefaultThumbnail =
                    tryResourceFromSequence(reader, isEmptyProperty);
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("AssetInformation", reader, tryElementName);
    ...
    private static Result<AssetInformation> tryAssetInformationFromElement(XMLEventReader reader) {
      skipWhitespaceAndComments(reader);
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class AssetInformation "
                    + "with element name assetInformation, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<AssetInformation> result = tryAssetInformationFromSequence(reader, isEmptyElement);
    ...
    private static Result<Resource> tryResourceFromSequence(
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
                    ...
                    final Reporting.Error error =
                        new Reporting.Error(
                            "The property path of an instance of class Resource "
                                + " could not be de-serialized: "
                                + e.getMessage());
                    error.prependSegment(new Reporting.NameSegment("path"));
                    return Result.failure(error);
                  }
                }
                break;
                    ...
                    final Reporting.Error error =
                        new Reporting.Error(
                            "The property contentType of an instance of class Resource "
                                + " could not be de-serialized: "
                                + e.getMessage());
                    error.prependSegment(new Reporting.NameSegment("contentType"));
                    return Result.failure(error);
                  }
                }
                break;
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("Resource", reader, tryElementName);
      ...
      return Result.success(new Resource(thePath, theContentType));
    }

    /** Deserialize an instance of class Resource from an XML element. */
    private static Result<Resource> tryResourceFromElement(XMLEventReader reader) {
      skipWhitespaceAndComments(reader);
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class Resource "
                    + "with element name resource, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<Resource> result = tryResourceFromSequence(reader, isEmptyElement);
    ...
    private static Result<SpecificAssetId> trySpecificAssetIdFromSequence(
        ...
        while (true) {
          ...
          switch (tryElementName.getResult()) {
            ...
            case "externalSubjectId":
              {
                Result<Reference> tryExternalSubjectId =
                    tryReferenceFromSequence(reader, isEmptyProperty);

                if (tryExternalSubjectId.isError()) {
                  tryExternalSubjectId
                      .getError()
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("SpecificAssetId", reader, tryElementName);
      ...
      return Result.success(
          new SpecificAssetId(
              theName, theValue, theSemanticId, theSupplementalSemanticIds, theExternalSubjectId));
    }

    /** Deserialize an instance of class SpecificAssetId from an XML element. */
    private static Result<SpecificAssetId> trySpecificAssetIdFromElement(XMLEventReader reader) {
      skipWhitespaceAndComments(reader);
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class SpecificAssetId "
                    + "with element name specificAssetId, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<SpecificAssetId> result = trySpecificAssetIdFromSequence(reader, isEmptyElement);
    ...
    private static Result<Submodel> trySubmodelFromSequence(
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
            ...
            case "kind":
              {
                ...
                final Optional<ModellingKind> optionalKind =
                    Stringification.modellingKindFromString(textKind);
            ...
            case "qualifiers":
              {
                ...
                if (!isEmptyProperty) {
                  ...
                  while (currentEvent(reader).isStartElement()) {
                    ...
                    if (itemResult.isError()) {
                      itemResult.getError().prependSegment(new Reporting.IndexSegment(index));
                      itemResult.getError().prependSegment(new Reporting.NameSegment("qualifiers"));
                      return itemResult.castTo(Submodel.class);
                    }
            ...
            case "submodelElements":
              {
                ...
                if (!isEmptyProperty) {
                  ...
                  while (currentEvent(reader).isStartElement()) {
                    ...
                    Result<? extends ISubmodelElement> itemResult =
                        tryISubmodelElementFromElement(reader);

                    if (itemResult.isError()) {
                      itemResult.getError().prependSegment(new Reporting.IndexSegment(index));
                      itemResult
                          .getError()
                          .prependSegment(new Reporting.NameSegment("submodelElements"));
                      return itemResult.castTo(Submodel.class);
                    }
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("Submodel", reader, tryElementName);
    ...
    private static Result<Submodel> trySubmodelFromElement(XMLEventReader reader) {
      skipWhitespaceAndComments(reader);
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class Submodel "
                    + "with element name submodel, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<Submodel> result = trySubmodelFromSequence(reader, isEmptyElement);
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
          ...
          switch (tryElementName.getResult()) {
            ...
            case "first":
              {
                Result<Reference> tryFirst = tryReferenceFromSequence(reader, isEmptyProperty);

                if (tryFirst.isError()) {
                  tryFirst.getError().prependSegment(new Reporting.NameSegment("first"));
            ...
            case "second":
              {
                Result<Reference> trySecond = tryReferenceFromSequence(reader, isEmptyProperty);

                if (trySecond.isError()) {
                  trySecond.getError().prependSegment(new Reporting.NameSegment("second"));
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("RelationshipElement", reader, tryElementName);
    ...
    private static Result<RelationshipElement> tryRelationshipElementFromElement(
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class RelationshipElement "
                    + "with element name relationshipElement, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<RelationshipElement> result =
          tryRelationshipElementFromSequence(reader, isEmptyElement);
        ...
        while (true) {
          ...
          switch (tryElementName.getResult()) {
                  ...
                  final Reporting.Error error =
                      new Reporting.Error(
                          "The property orderRelevant of an instance of class SubmodelElementList "
                              + "can not be de-serialized from a self-closing element "
                              + "since it needs content");
                  error.prependSegment(new Reporting.NameSegment("orderRelevant"));
                  return Result.failure(error);
                } else {
                  if (currentEvent(reader).isEndDocument()) {
                    final Reporting.Error error =
            ...
            case "semanticIdListElement":
              {
                Result<Reference> trySemanticIdListElement =
                    tryReferenceFromSequence(reader, isEmptyProperty);

                if (trySemanticIdListElement.isError()) {
                  trySemanticIdListElement
                      .getError()
            ...
            case "typeValueListElement":
              {
                  ...
                  final Reporting.Error error =
                      new Reporting.Error(
                          "The property typeValueListElement of an instance of class SubmodelElementList "
                              + "can not be de-serialized from a self-closing element "
                              + "since it needs content");
                  error.prependSegment(new Reporting.NameSegment("typeValueListElement"));
                  return Result.failure(error);
                }
                ...
                final Optional<AasSubmodelElements> optionalTypeValueListElement =
                    Stringification.aasSubmodelElementsFromString(textTypeValueListElement);
            ...
            case "valueTypeListElement":
              {
                  ...
                  final Reporting.Error error =
                      new Reporting.Error(
                          "The property valueTypeListElement of an instance of class SubmodelElementList "
                              + "can not be de-serialized from a self-closing element "
                              + "since it needs content");
                  error.prependSegment(new Reporting.NameSegment("valueTypeListElement"));
                  return Result.failure(error);
                }
                ...
                final Optional<DataTypeDefXsd> optionalValueTypeListElement =
                    Stringification.dataTypeDefXsdFromString(textValueTypeListElement);
            ...
            case "value":
              {
                ...
                if (!isEmptyProperty) {
                  ...
                  while (currentEvent(reader).isStartElement()) {
                    ...
                    if (itemResult.isError()) {
                      itemResult.getError().prependSegment(new Reporting.IndexSegment(index));
                      itemResult.getError().prependSegment(new Reporting.NameSegment("value"));
                      return itemResult.castTo(SubmodelElementList.class);
                    }
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("SubmodelElementList", reader, tryElementName);
    ...
    private static Result<SubmodelElementList> trySubmodelElementListFromElement(
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class SubmodelElementList "
                    + "with element name submodelElementList, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<SubmodelElementList> result =
          trySubmodelElementListFromSequence(reader, isEmptyElement);
    ...
    private static Result<SubmodelElementCollection> trySubmodelElementCollectionFromSequence(
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("SubmodelElementCollection", reader, tryElementName);
          if (checkEndElement.isError())
            return checkEndElement.castTo(SubmodelElementCollection.class);
        }
      }
    ...
    private static Result<SubmodelElementCollection> trySubmodelElementCollectionFromElement(
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class SubmodelElementCollection "
                    + "with element name submodelElementCollection, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<SubmodelElementCollection> result =
          trySubmodelElementCollectionFromSequence(reader, isEmptyElement);
    ...
    private static Result<Property> tryPropertyFromSequence(
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("Property", reader, tryElementName);
    ...
    private static Result<Property> tryPropertyFromElement(XMLEventReader reader) {
      skipWhitespaceAndComments(reader);
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class Property "
                    + "with element name property, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<Property> result = tryPropertyFromSequence(reader, isEmptyElement);
    ...
    private static Result<MultiLanguageProperty> tryMultiLanguagePropertyFromSequence(
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("MultiLanguageProperty", reader, tryElementName);
    ...
    private static Result<MultiLanguageProperty> tryMultiLanguagePropertyFromElement(
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class MultiLanguageProperty "
                    + "with element name multiLanguageProperty, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<MultiLanguageProperty> result =
          tryMultiLanguagePropertyFromSequence(reader, isEmptyElement);
    ...
    private static Result<Range> tryRangeFromSequence(
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
                    ...
                    final Reporting.Error error =
                        new Reporting.Error(
                            "The property min of an instance of class Range "
                                + " could not be de-serialized: "
                                + e.getMessage());
                    error.prependSegment(new Reporting.NameSegment("min"));
                    return Result.failure(error);
                  }
                }
                break;
                    ...
                    final Reporting.Error error =
                        new Reporting.Error(
                            "The property max of an instance of class Range "
                                + " could not be de-serialized: "
                                + e.getMessage());
                    error.prependSegment(new Reporting.NameSegment("max"));
                    return Result.failure(error);
                  }
                }
                break;
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("Range", reader, tryElementName);
    ...
    private static Result<Range> tryRangeFromElement(XMLEventReader reader) {
      skipWhitespaceAndComments(reader);
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class Range "
                    + "with element name range, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<Range> result = tryRangeFromSequence(reader, isEmptyElement);
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
          ...
          switch (tryElementName.getResult()) {
            ...
            case "value":
              {
                Result<Reference> tryValue = tryReferenceFromSequence(reader, isEmptyProperty);

                if (tryValue.isError()) {
                  tryValue.getError().prependSegment(new Reporting.NameSegment("value"));
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("ReferenceElement", reader, tryElementName);
    ...
    private static Result<ReferenceElement> tryReferenceElementFromElement(XMLEventReader reader) {
      skipWhitespaceAndComments(reader);
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class ReferenceElement "
                    + "with element name referenceElement, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<ReferenceElement> result = tryReferenceElementFromSequence(reader, isEmptyElement);
    ...
    private static Result<Blob> tryBlobFromSequence(
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("Blob", reader, tryElementName);
    ...
    private static Result<Blob> tryBlobFromElement(XMLEventReader reader) {
      skipWhitespaceAndComments(reader);
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class Blob "
                    + "with element name blob, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<Blob> result = tryBlobFromSequence(reader, isEmptyElement);
    ...
    private static Result<File> tryFileFromSequence(
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("File", reader, tryElementName);
    ...
    private static Result<File> tryFileFromElement(XMLEventReader reader) {
      skipWhitespaceAndComments(reader);
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class File "
                    + "with element name file, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<File> result = tryFileFromSequence(reader, isEmptyElement);
    ...
    /**
     * Deserialize an instance of class AnnotatedRelationshipElement from a sequence of XML
     * elements.
     *
     * <p>If {@code isEmptySequence} is set, we should try to deserialize the instance from an empty
     * sequence. That is, the parent element was a self-closing element.
    ...
    private static Result<AnnotatedRelationshipElement> tryAnnotatedRelationshipElementFromSequence(
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
                ...
                if (!isEmptyProperty) {
                  ...
                  while (currentEvent(reader).isStartElement()) {
                    ...
                    if (itemResult.isError()) {
                      ...
                      itemResult
                          .getError()
                          .prependSegment(new Reporting.NameSegment("annotations"));
                      return itemResult.castTo(AnnotatedRelationshipElement.class);
                    }
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("AnnotatedRelationshipElement", reader, tryElementName);
          if (checkEndElement.isError())
            return checkEndElement.castTo(AnnotatedRelationshipElement.class);
        }
      }
    ...
    private static Result<AnnotatedRelationshipElement> tryAnnotatedRelationshipElementFromElement(
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class AnnotatedRelationshipElement "
                    + "with element name annotatedRelationshipElement, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<AnnotatedRelationshipElement> result =
          tryAnnotatedRelationshipElementFromSequence(reader, isEmptyElement);
    ...
    private static Result<Entity> tryEntityFromSequence(
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
            ...
            case "statements":
              {
                ...
                if (!isEmptyProperty) {
                  ...
                  while (currentEvent(reader).isStartElement()) {
                    ...
                    if (itemResult.isError()) {
                      itemResult.getError().prependSegment(new Reporting.IndexSegment(index));
                      itemResult.getError().prependSegment(new Reporting.NameSegment("statements"));
                      return itemResult.castTo(Entity.class);
                    }
            ...
            case "entityType":
              {
                  ...
                  final Reporting.Error error =
                      new Reporting.Error(
                          "The property entityType of an instance of class Entity "
                              + "can not be de-serialized from a self-closing element "
                              + "since it needs content");
                  error.prependSegment(new Reporting.NameSegment("entityType"));
                  return Result.failure(error);
                }
                ...
                final Optional<EntityType> optionalEntityType =
                    Stringification.entityTypeFromString(textEntityType);
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("Entity", reader, tryElementName);
    ...
    private static Result<Entity> tryEntityFromElement(XMLEventReader reader) {
      skipWhitespaceAndComments(reader);
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class Entity "
                    + "with element name entity, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<Entity> result = tryEntityFromSequence(reader, isEmptyElement);
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
          ...
          switch (tryElementName.getResult()) {
            case "source":
              {
                Result<Reference> trySource = tryReferenceFromSequence(reader, isEmptyProperty);

                if (trySource.isError()) {
                  trySource.getError().prependSegment(new Reporting.NameSegment("source"));
            ...
            case "sourceSemanticId":
              {
                Result<Reference> trySourceSemanticId =
                    tryReferenceFromSequence(reader, isEmptyProperty);
            ...
            case "observableReference":
              {
                Result<Reference> tryObservableReference =
                    tryReferenceFromSequence(reader, isEmptyProperty);

                if (tryObservableReference.isError()) {
                  tryObservableReference
                      .getError()
            ...
            case "observableSemanticId":
              {
                Result<Reference> tryObservableSemanticId =
                    tryReferenceFromSequence(reader, isEmptyProperty);

                if (tryObservableSemanticId.isError()) {
                  tryObservableSemanticId
                      .getError()
                    ...
                    final Reporting.Error error =
                        new Reporting.Error(
                            "The property topic of an instance of class EventPayload "
                                + " could not be de-serialized: "
                                + e.getMessage());
                    error.prependSegment(new Reporting.NameSegment("topic"));
                    return Result.failure(error);
                  }
                }
                break;
            ...
            case "subjectId":
              {
                Result<Reference> trySubjectId = tryReferenceFromSequence(reader, isEmptyProperty);

                if (trySubjectId.isError()) {
                  trySubjectId.getError().prependSegment(new Reporting.NameSegment("subjectId"));
                    ...
                    final Reporting.Error error =
                        new Reporting.Error(
                            "The property timeStamp of an instance of class EventPayload "
                                + " could not be de-serialized: "
                                + e.getMessage());
                    error.prependSegment(new Reporting.NameSegment("timeStamp"));
                    return Result.failure(error);
                  }
                }
                break;
                  ...
                  final Reporting.Error error =
                      new Reporting.Error(
                          "The property payload of an instance of class EventPayload "
                              + "can not be de-serialized from a self-closing element "
                              + "since it needs content");
                  error.prependSegment(new Reporting.NameSegment("payload"));
                  return Result.failure(error);
                } else {
                  if (currentEvent(reader).isEndDocument()) {
                    final Reporting.Error error =
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("EventPayload", reader, tryElementName);
    ...
    private static Result<EventPayload> tryEventPayloadFromElement(XMLEventReader reader) {
      skipWhitespaceAndComments(reader);
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class EventPayload "
                    + "with element name eventPayload, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<EventPayload> result = tryEventPayloadFromSequence(reader, isEmptyElement);
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
          ...
          switch (tryElementName.getResult()) {
            ...
            case "observed":
              {
                Result<Reference> tryObserved = tryReferenceFromSequence(reader, isEmptyProperty);

                if (tryObserved.isError()) {
                  tryObserved.getError().prependSegment(new Reporting.NameSegment("observed"));
            ...
            case "direction":
              {
                  ...
                  final Reporting.Error error =
                      new Reporting.Error(
                          "The property direction of an instance of class BasicEventElement "
                              + "can not be de-serialized from a self-closing element "
                              + "since it needs content");
                  error.prependSegment(new Reporting.NameSegment("direction"));
                  return Result.failure(error);
                }
                ...
                final Optional<Direction> optionalDirection =
                    Stringification.directionFromString(textDirection);
            ...
            case "state":
              {
                  ...
                  final Reporting.Error error =
                      new Reporting.Error(
                          "The property state of an instance of class BasicEventElement "
                              + "can not be de-serialized from a self-closing element "
                              + "since it needs content");
                  error.prependSegment(new Reporting.NameSegment("state"));
                  return Result.failure(error);
                }
                ...
                final Optional<StateOfEvent> optionalState =
                    Stringification.stateOfEventFromString(textState);
                    ...
                    final Reporting.Error error =
                        new Reporting.Error(
                            "The property messageTopic of an instance of class BasicEventElement "
                                + " could not be de-serialized: "
                                + e.getMessage());
                    error.prependSegment(new Reporting.NameSegment("messageTopic"));
                    return Result.failure(error);
                  }
                }
                break;
            ...
            case "messageBroker":
              {
                Result<Reference> tryMessageBroker =
                    tryReferenceFromSequence(reader, isEmptyProperty);
                    ...
                    final Reporting.Error error =
                        new Reporting.Error(
                            "The property lastUpdate of an instance of class BasicEventElement "
                                + " could not be de-serialized: "
                                + e.getMessage());
                    error.prependSegment(new Reporting.NameSegment("lastUpdate"));
                    return Result.failure(error);
                  }
                }
                break;
                    ...
                    final Reporting.Error error =
                        new Reporting.Error(
                            "The property minInterval of an instance of class BasicEventElement "
                                + " could not be de-serialized: "
                                + e.getMessage());
                    error.prependSegment(new Reporting.NameSegment("minInterval"));
                    return Result.failure(error);
                  }
                }
                break;
                    ...
                    final Reporting.Error error =
                        new Reporting.Error(
                            "The property maxInterval of an instance of class BasicEventElement "
                                + " could not be de-serialized: "
                                + e.getMessage());
                    error.prependSegment(new Reporting.NameSegment("maxInterval"));
                    return Result.failure(error);
                  }
                }
                break;
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("BasicEventElement", reader, tryElementName);
    ...
    private static Result<BasicEventElement> tryBasicEventElementFromElement(
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class BasicEventElement "
                    + "with element name basicEventElement, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<BasicEventElement> result = tryBasicEventElementFromSequence(reader, isEmptyElement);
    ...
    private static Result<Operation> tryOperationFromSequence(
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
            ...
            case "inputVariables":
              {
                ...
                if (!isEmptyProperty) {
                  ...
                  while (currentEvent(reader).isStartElement()) {
                    ...
                    Result<? extends IOperationVariable> itemResult =
                        tryOperationVariableFromElement(reader);

                    if (itemResult.isError()) {
                      itemResult.getError().prependSegment(new Reporting.IndexSegment(index));
                      itemResult
                          .getError()
                          .prependSegment(new Reporting.NameSegment("inputVariables"));
                      return itemResult.castTo(Operation.class);
                    }
                ...
                if (!isEmptyProperty) {
                  ...
                  while (currentEvent(reader).isStartElement()) {
                    ...
                    if (itemResult.isError()) {
                      ...
                      itemResult
                          .getError()
                          .prependSegment(new Reporting.NameSegment("outputVariables"));
                      return itemResult.castTo(Operation.class);
                    }
                ...
                if (!isEmptyProperty) {
                  ...
                  while (currentEvent(reader).isStartElement()) {
                    ...
                    if (itemResult.isError()) {
                      ...
                      itemResult
                          .getError()
                          .prependSegment(new Reporting.NameSegment("inoutputVariables"));
                      return itemResult.castTo(Operation.class);
                    }
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("Operation", reader, tryElementName);
    ...
    private static Result<Operation> tryOperationFromElement(XMLEventReader reader) {
      skipWhitespaceAndComments(reader);
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class Operation "
                    + "with element name operation, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<Operation> result = tryOperationFromSequence(reader, isEmptyElement);
    ...
    private static Result<OperationVariable> tryOperationVariableFromSequence(
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
            ...
            case "value":
              {
                if (isEmptyProperty) {
                  final Reporting.Error error =
                      new Reporting.Error(
                          "Expected an XML element within the element "
                              + tryElementName.getResult()
                              + " representing "
                ...
                Result<? extends ISubmodelElement> tryValue =
                    tryISubmodelElementFromElement(reader);
                ...
                if (tryValue.isError()) {
                  if (discriminatorElementName != null) {
                    tryValue
                        .getError()
                        .prependSegment(new Reporting.NameSegment(discriminatorElementName));
                  }
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("OperationVariable", reader, tryElementName);
      ...
      return Result.success(new OperationVariable(theValue));
    }
    ...
    private static Result<OperationVariable> tryOperationVariableFromElement(
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class OperationVariable "
                    + "with element name operationVariable, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<OperationVariable> result = tryOperationVariableFromSequence(reader, isEmptyElement);
    ...
    private static Result<Capability> tryCapabilityFromSequence(
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("Capability", reader, tryElementName);
    ...
    private static Result<Capability> tryCapabilityFromElement(XMLEventReader reader) {
      skipWhitespaceAndComments(reader);
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class Capability "
                    + "with element name capability, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<Capability> result = tryCapabilityFromSequence(reader, isEmptyElement);
    ...
    private static Result<ConceptDescription> tryConceptDescriptionFromSequence(
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
            ...
            case "isCaseOf":
              {
                ...
                if (!isEmptyProperty) {
                  ...
                  while (currentEvent(reader).isStartElement()) {
                    ...
                    if (itemResult.isError()) {
                      itemResult.getError().prependSegment(new Reporting.IndexSegment(index));
                      itemResult.getError().prependSegment(new Reporting.NameSegment("isCaseOf"));
                      return itemResult.castTo(ConceptDescription.class);
                    }
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("ConceptDescription", reader, tryElementName);
    ...
    private static Result<ConceptDescription> tryConceptDescriptionFromElement(
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class ConceptDescription "
                    + "with element name conceptDescription, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<ConceptDescription> result = tryConceptDescriptionFromSequence(reader, isEmptyElement);
    ...
    private static Result<Reference> tryReferenceFromSequence(
        ...
        while (true) {
          ...
          switch (tryElementName.getResult()) {
            case "type":
              {
                ...
                final Optional<ReferenceTypes> optionalType =
                    Stringification.referenceTypesFromString(textType);
            ...
            case "referredSemanticId":
              {
                Result<Reference> tryReferredSemanticId =
                    tryReferenceFromSequence(reader, isEmptyProperty);

                if (tryReferredSemanticId.isError()) {
                  tryReferredSemanticId
                      .getError()
            ...
            case "keys":
              {
                ...
                if (!isEmptyProperty) {
                  ...
                  while (currentEvent(reader).isStartElement()) {
                    ...
                    if (itemResult.isError()) {
                      itemResult.getError().prependSegment(new Reporting.IndexSegment(index));
                      itemResult.getError().prependSegment(new Reporting.NameSegment("keys"));
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("Reference", reader, tryElementName);
      ...
      return Result.success(new Reference(theType, theKeys, theReferredSemanticId));
    }

    /** Deserialize an instance of class Reference from an XML element. */
    private static Result<Reference> tryReferenceFromElement(XMLEventReader reader) {
      skipWhitespaceAndComments(reader);
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class Reference "
                    + "with element name reference, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<Reference> result = tryReferenceFromSequence(reader, isEmptyElement);
     ...
     * sequence. That is, the parent element was a self-closing element.
     */
    private static Result<Key> tryKeyFromSequence(XMLEventReader reader, boolean isEmptySequence) {
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
            ...
            case "type":
              {
                ...
                final Optional<KeyTypes> optionalType =
                    Stringification.keyTypesFromString(textType);
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("Key", reader, tryElementName);
      ...
      return Result.success(new Key(theType, theValue));
    }

    /** Deserialize an instance of class Key from an XML element. */
    private static Result<Key> tryKeyFromElement(XMLEventReader reader) {
      skipWhitespaceAndComments(reader);
      ...
      Result<Key> result = tryKeyFromSequence(reader, isEmptyElement);
    ...
    private static Result<LangStringNameType> tryLangStringNameTypeFromSequence(
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
                    ...
                    final Reporting.Error error =
                        new Reporting.Error(
                            "The property text of an instance of class LangStringNameType "
                                + " could not be de-serialized: "
                                + e.getMessage());
                    error.prependSegment(new Reporting.NameSegment("text"));
                    return Result.failure(error);
                  }
                }
                break;
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("LangStringNameType", reader, tryElementName);
      ...
      return Result.success(new LangStringNameType(theLanguage, theText));
    }
    ...
    private static Result<LangStringNameType> tryLangStringNameTypeFromElement(
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class LangStringNameType "
                    + "with element name langStringNameType, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<LangStringNameType> result = tryLangStringNameTypeFromSequence(reader, isEmptyElement);
    ...
    private static Result<LangStringTextType> tryLangStringTextTypeFromSequence(
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("LangStringTextType", reader, tryElementName);
      ...
      return Result.success(new LangStringTextType(theLanguage, theText));
    }
    ...
    private static Result<LangStringTextType> tryLangStringTextTypeFromElement(
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class LangStringTextType "
                    + "with element name langStringTextType, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<LangStringTextType> result = tryLangStringTextTypeFromSequence(reader, isEmptyElement);
    ...
    private static Result<Environment> tryEnvironmentFromSequence(
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
            ...
            case "assetAdministrationShells":
              {
                ...
                if (!isEmptyProperty) {
                  ...
                  while (currentEvent(reader).isStartElement()) {
                    ...
                    Result<? extends IAssetAdministrationShell> itemResult =
                        tryAssetAdministrationShellFromElement(reader);

                    if (itemResult.isError()) {
                      itemResult.getError().prependSegment(new Reporting.IndexSegment(index));
                      itemResult
                          .getError()
                          .prependSegment(new Reporting.NameSegment("assetAdministrationShells"));
            ...
            case "conceptDescriptions":
              {
                ...
                if (!isEmptyProperty) {
                  ...
                  while (currentEvent(reader).isStartElement()) {
                    ...
                    Result<? extends IConceptDescription> itemResult =
                        tryConceptDescriptionFromElement(reader);

                    if (itemResult.isError()) {
                      itemResult.getError().prependSegment(new Reporting.IndexSegment(index));
                      itemResult
                          .getError()
                          .prependSegment(new Reporting.NameSegment("conceptDescriptions"));
                      return itemResult.castTo(Environment.class);
                    }
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("Environment", reader, tryElementName);
          if (checkEndElement.isError()) return checkEndElement.castTo(Environment.class);
        }
      }

      return Result.success(
          new Environment(theAssetAdministrationShells, theSubmodels, theConceptDescriptions));
    }

    /** Deserialize an instance of class Environment from an XML element. */
    private static Result<Environment> tryEnvironmentFromElement(XMLEventReader reader) {
      skipWhitespaceAndComments(reader);
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class Environment "
                    + "with element name environment, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<Environment> result = tryEnvironmentFromSequence(reader, isEmptyElement);
    ...
    private static Result<? extends IDataSpecificationContent>
        tryIDataSpecificationContentFromElement(XMLEventReader reader) {
      skipWhitespaceAndComments(reader);
    ...
    private static Result<EmbeddedDataSpecification> tryEmbeddedDataSpecificationFromSequence(
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
            ...
            case "dataSpecificationContent":
              {
                ...
                Result<? extends IDataSpecificationContent> tryDataSpecificationContent =
                    tryIDataSpecificationContentFromElement(reader);

                if (tryDataSpecificationContent.isError()) {
                  if (discriminatorElementName != null) {
                    tryDataSpecificationContent
                        .getError()
                        .prependSegment(new Reporting.NameSegment(discriminatorElementName));
                  }
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("EmbeddedDataSpecification", reader, tryElementName);
          if (checkEndElement.isError())
            return checkEndElement.castTo(EmbeddedDataSpecification.class);
        }
      }
    ...
    private static Result<EmbeddedDataSpecification> tryEmbeddedDataSpecificationFromElement(
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class EmbeddedDataSpecification "
                    + "with element name embeddedDataSpecification, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<EmbeddedDataSpecification> result =
          tryEmbeddedDataSpecificationFromSequence(reader, isEmptyElement);
    ...
    private static Result<LevelType> tryLevelTypeFromSequence(
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
                  ...
                  final Reporting.Error error =
                      new Reporting.Error(
                          "The property nom of an instance of class LevelType "
                              + "can not be de-serialized from a self-closing element "
                              + "since it needs content");
                  error.prependSegment(new Reporting.NameSegment("nom"));
                  return Result.failure(error);
                } else {
                  if (currentEvent(reader).isEndDocument()) {
                    final Reporting.Error error =
                  ...
                  final Reporting.Error error =
                      new Reporting.Error(
                          "The property typ of an instance of class LevelType "
                              + "can not be de-serialized from a self-closing element "
                              + "since it needs content");
                  error.prependSegment(new Reporting.NameSegment("typ"));
                  return Result.failure(error);
                } else {
                  if (currentEvent(reader).isEndDocument()) {
                    final Reporting.Error error =
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("LevelType", reader, tryElementName);
      ...
      return Result.success(new LevelType(theMin, theNom, theTyp, theMax));
    }

    /** Deserialize an instance of class LevelType from an XML element. */
    private static Result<LevelType> tryLevelTypeFromElement(XMLEventReader reader) {
      skipWhitespaceAndComments(reader);
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class LevelType "
                    + "with element name levelType, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<LevelType> result = tryLevelTypeFromSequence(reader, isEmptyElement);
    ...
    private static Result<ValueReferencePair> tryValueReferencePairFromSequence(
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("ValueReferencePair", reader, tryElementName);
      ...
      return Result.success(new ValueReferencePair(theValue, theValueId));
    }
    ...
    private static Result<ValueReferencePair> tryValueReferencePairFromElement(
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class ValueReferencePair "
                    + "with element name valueReferencePair, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<ValueReferencePair> result = tryValueReferencePairFromSequence(reader, isEmptyElement);
    ...
    private static Result<ValueList> tryValueListFromSequence(
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
            ...
            case "valueReferencePairs":
              {
                ...
                if (!isEmptyProperty) {
                  ...
                  while (currentEvent(reader).isStartElement()) {
                    ...
                    Result<? extends IValueReferencePair> itemResult =
                        tryValueReferencePairFromElement(reader);

                    if (itemResult.isError()) {
                      itemResult.getError().prependSegment(new Reporting.IndexSegment(index));
                      itemResult
                          .getError()
                          .prependSegment(new Reporting.NameSegment("valueReferencePairs"));
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("ValueList", reader, tryElementName);
      ...
      return Result.success(new ValueList(theValueReferencePairs));
    }

    /** Deserialize an instance of class ValueList from an XML element. */
    private static Result<ValueList> tryValueListFromElement(XMLEventReader reader) {
      skipWhitespaceAndComments(reader);
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class ValueList "
                    + "with element name valueList, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<ValueList> result = tryValueListFromSequence(reader, isEmptyElement);
    ...
    /**
     * Deserialize an instance of class LangStringPreferredNameTypeIec61360 from a sequence of XML
     * elements.
     *
     * <p>If {@code isEmptySequence} is set, we should try to deserialize the instance from an empty
     * sequence. That is, the parent element was a self-closing element.
     */
    private static Result<LangStringPreferredNameTypeIec61360>
        tryLangStringPreferredNameTypeIec61360FromSequence(
            XMLEventReader reader, boolean isEmptySequence) {
      String theLanguage = null;
      String theText = null;
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass(
                  "LangStringPreferredNameTypeIec61360", reader, tryElementName);
          if (checkEndElement.isError())
            return checkEndElement.castTo(LangStringPreferredNameTypeIec61360.class);
        }
      }
      ...
      return Result.success(new LangStringPreferredNameTypeIec61360(theLanguage, theText));
    }

    /** Deserialize an instance of class LangStringPreferredNameTypeIec61360 from an XML element. */
    private static Result<LangStringPreferredNameTypeIec61360>
        tryLangStringPreferredNameTypeIec61360FromElement(XMLEventReader reader) {
      skipWhitespaceAndComments(reader);
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class LangStringPreferredNameTypeIec61360 "
                    + "with element name langStringPreferredNameTypeIec61360, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<LangStringPreferredNameTypeIec61360> result =
          tryLangStringPreferredNameTypeIec61360FromSequence(reader, isEmptyElement);
      if (result.isError()) return result.castTo(LangStringPreferredNameTypeIec61360.class);

      final Result<XMLEvent> checkEndElement =
          verifyClosingTagForClass("LangStringPreferredNameTypeIec61360", reader, tryElementName);
      if (checkEndElement.isError())
        return checkEndElement.castTo(LangStringPreferredNameTypeIec61360.class);
    ...
    /**
     * Deserialize an instance of class LangStringShortNameTypeIec61360 from a sequence of XML
     * elements.
     *
     * <p>If {@code isEmptySequence} is set, we should try to deserialize the instance from an empty
     * sequence. That is, the parent element was a self-closing element.
     */
    private static Result<LangStringShortNameTypeIec61360>
        tryLangStringShortNameTypeIec61360FromSequence(
            XMLEventReader reader, boolean isEmptySequence) {
      String theLanguage = null;
      String theText = null;
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("LangStringShortNameTypeIec61360", reader, tryElementName);
          if (checkEndElement.isError())
            return checkEndElement.castTo(LangStringShortNameTypeIec61360.class);
        }
      }
      ...
      return Result.success(new LangStringShortNameTypeIec61360(theLanguage, theText));
    }

    /** Deserialize an instance of class LangStringShortNameTypeIec61360 from an XML element. */
    private static Result<LangStringShortNameTypeIec61360>
        tryLangStringShortNameTypeIec61360FromElement(XMLEventReader reader) {
      skipWhitespaceAndComments(reader);
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class LangStringShortNameTypeIec61360 "
                    + "with element name langStringShortNameTypeIec61360, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<LangStringShortNameTypeIec61360> result =
          tryLangStringShortNameTypeIec61360FromSequence(reader, isEmptyElement);
    ...
    /**
     * Deserialize an instance of class LangStringDefinitionTypeIec61360 from a sequence of XML
     * elements.
     *
     * <p>If {@code isEmptySequence} is set, we should try to deserialize the instance from an empty
     * sequence. That is, the parent element was a self-closing element.
     */
    private static Result<LangStringDefinitionTypeIec61360>
        tryLangStringDefinitionTypeIec61360FromSequence(
            XMLEventReader reader, boolean isEmptySequence) {
      String theLanguage = null;
      String theText = null;
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("LangStringDefinitionTypeIec61360", reader, tryElementName);
          if (checkEndElement.isError())
            return checkEndElement.castTo(LangStringDefinitionTypeIec61360.class);
        }
      }
      ...
      return Result.success(new LangStringDefinitionTypeIec61360(theLanguage, theText));
    }

    /** Deserialize an instance of class LangStringDefinitionTypeIec61360 from an XML element. */
    private static Result<LangStringDefinitionTypeIec61360>
        tryLangStringDefinitionTypeIec61360FromElement(XMLEventReader reader) {
      skipWhitespaceAndComments(reader);
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class LangStringDefinitionTypeIec61360 "
                    + "with element name langStringDefinitionTypeIec61360, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<LangStringDefinitionTypeIec61360> result =
          tryLangStringDefinitionTypeIec61360FromSequence(reader, isEmptyElement);
      ...
      if (!isEmptySequence) {
        ...
        while (true) {
          ...
          switch (tryElementName.getResult()) {
            case "preferredName":
              {
                ...
                if (!isEmptyProperty) {
                  ...
                  while (currentEvent(reader).isStartElement()) {
                    ...
                    Result<? extends ILangStringPreferredNameTypeIec61360> itemResult =
                        tryLangStringPreferredNameTypeIec61360FromElement(reader);

                    if (itemResult.isError()) {
                      itemResult.getError().prependSegment(new Reporting.IndexSegment(index));
                      itemResult
                          .getError()
                          .prependSegment(new Reporting.NameSegment("preferredName"));
            ...
            case "shortName":
              {
                ...
                if (!isEmptyProperty) {
                  ...
                  while (currentEvent(reader).isStartElement()) {
                    ...
                    Result<? extends ILangStringShortNameTypeIec61360> itemResult =
                        tryLangStringShortNameTypeIec61360FromElement(reader);

                    if (itemResult.isError()) {
                      itemResult.getError().prependSegment(new Reporting.IndexSegment(index));
                      itemResult.getError().prependSegment(new Reporting.NameSegment("shortName"));
                      return itemResult.castTo(DataSpecificationIec61360.class);
                    }
                    ...
                    final Reporting.Error error =
                        new Reporting.Error(
                            "The property unit of an instance of class DataSpecificationIec61360 "
                                + " could not be de-serialized: "
                                + e.getMessage());
                    error.prependSegment(new Reporting.NameSegment("unit"));
                    return Result.failure(error);
                  }
                }
                break;
            ...
            case "unitId":
              {
                Result<Reference> tryUnitId = tryReferenceFromSequence(reader, isEmptyProperty);

                if (tryUnitId.isError()) {
                  tryUnitId.getError().prependSegment(new Reporting.NameSegment("unitId"));
                    ...
                    final Reporting.Error error =
                        new Reporting.Error(
                            "The property sourceOfDefinition of an instance of class DataSpecificationIec61360 "
                                + " could not be de-serialized: "
                                + e.getMessage());
                    error.prependSegment(new Reporting.NameSegment("sourceOfDefinition"));
                    return Result.failure(error);
                  }
                }
                break;
                    ...
                    final Reporting.Error error =
                        new Reporting.Error(
                            "The property symbol of an instance of class DataSpecificationIec61360 "
                                + " could not be de-serialized: "
                                + e.getMessage());
                    error.prependSegment(new Reporting.NameSegment("symbol"));
                    return Result.failure(error);
                  }
                }
                break;
            ...
            case "dataType":
              {
                  ...
                  final Reporting.Error error =
                      new Reporting.Error(
                          "The property dataType of an instance of class DataSpecificationIec61360 "
                              + "can not be de-serialized from a self-closing element "
                              + "since it needs content");
                  error.prependSegment(new Reporting.NameSegment("dataType"));
                  return Result.failure(error);
                }
                ...
                final Optional<DataTypeIec61360> optionalDataType =
                    Stringification.dataTypeIec61360FromString(textDataType);
            ...
            case "definition":
              {
                ...
                if (!isEmptyProperty) {
                  ...
                  while (currentEvent(reader).isStartElement()) {
                    ...
                    Result<? extends ILangStringDefinitionTypeIec61360> itemResult =
                        tryLangStringDefinitionTypeIec61360FromElement(reader);

                    if (itemResult.isError()) {
                      itemResult.getError().prependSegment(new Reporting.IndexSegment(index));
                      itemResult.getError().prependSegment(new Reporting.NameSegment("definition"));
                      return itemResult.castTo(DataSpecificationIec61360.class);
                    }
                    ...
                    final Reporting.Error error =
                        new Reporting.Error(
                            "The property valueFormat of an instance of class DataSpecificationIec61360 "
                                + " could not be de-serialized: "
                                + e.getMessage());
                    error.prependSegment(new Reporting.NameSegment("valueFormat"));
                    return Result.failure(error);
                  }
                }
                break;
            ...
            case "valueList":
              {
                Result<ValueList> tryValueList = tryValueListFromSequence(reader, isEmptyProperty);

                if (tryValueList.isError()) {
                  tryValueList.getError().prependSegment(new Reporting.NameSegment("valueList"));
            ...
            case "levelType":
              {
                Result<LevelType> tryLevelType = tryLevelTypeFromSequence(reader, isEmptyProperty);

                if (tryLevelType.isError()) {
                  tryLevelType.getError().prependSegment(new Reporting.NameSegment("levelType"));
          ...
          final Result<XMLEvent> checkEndElement =
              verifyClosingTagForClass("DataSpecificationIec61360", reader, tryElementName);
          if (checkEndElement.isError())
            return checkEndElement.castTo(DataSpecificationIec61360.class);
        }
      }
    ...
    private static Result<DataSpecificationIec61360> tryDataSpecificationIec61360FromElement(
        ...
        final Reporting.Error error =
            new Reporting.Error(
                "Expected an element representing an instance of class DataSpecificationIec61360 "
                    + "with element name dataSpecificationIec61360, but got: "
                    + elementName);
        return Result.failure(error);
      }
      ...
      Result<DataSpecificationIec61360> result =
          tryDataSpecificationIec61360FromSequence(reader, isEmptyElement);
  ...
  public static class Deserialize {
     ...
     */
    public static IHasSemantics deserializeIHasSemantics(XMLEventReader reader) {
      ...
      Result<? extends IHasSemantics> result =
          DeserializeImplementation.tryIHasSemanticsFromElement(reader);

      return result.onError(
          error -> {
            error.prependSegment(new Reporting.NameSegment("ihassemantics"));
            throw new DeserializeException(
                Reporting.generateRelativeXPath(error.getPathSegments()), error.getCause());
          });
    }
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static Extension deserializeExtension(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends Extension> result =
          DeserializeImplementation.tryExtensionFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static IHasExtensions deserializeIHasExtensions(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends IHasExtensions> result =
          DeserializeImplementation.tryIHasExtensionsFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static IReferable deserializeIReferable(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends IReferable> result =
          DeserializeImplementation.tryIReferableFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static IIdentifiable deserializeIIdentifiable(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends IIdentifiable> result =
          DeserializeImplementation.tryIIdentifiableFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static IHasKind deserializeIHasKind(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends IHasKind> result = DeserializeImplementation.tryIHasKindFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static IHasDataSpecification deserializeIHasDataSpecification(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends IHasDataSpecification> result =
          DeserializeImplementation.tryIHasDataSpecificationFromElement(reader);
    ...
    public static AdministrativeInformation deserializeAdministrativeInformation(
      ...
      Result<? extends AdministrativeInformation> result =
          DeserializeImplementation.tryAdministrativeInformationFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static IQualifiable deserializeIQualifiable(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends IQualifiable> result =
          DeserializeImplementation.tryIQualifiableFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static Qualifier deserializeQualifier(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends Qualifier> result =
          DeserializeImplementation.tryQualifierFromElement(reader);
    ...
    public static AssetAdministrationShell deserializeAssetAdministrationShell(
      ...
      Result<? extends AssetAdministrationShell> result =
          DeserializeImplementation.tryAssetAdministrationShellFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static AssetInformation deserializeAssetInformation(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends AssetInformation> result =
          DeserializeImplementation.tryAssetInformationFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static Resource deserializeResource(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends Resource> result = DeserializeImplementation.tryResourceFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static SpecificAssetId deserializeSpecificAssetId(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends SpecificAssetId> result =
          DeserializeImplementation.trySpecificAssetIdFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static Submodel deserializeSubmodel(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends Submodel> result = DeserializeImplementation.trySubmodelFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static ISubmodelElement deserializeISubmodelElement(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends ISubmodelElement> result =
          DeserializeImplementation.tryISubmodelElementFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static IRelationshipElement deserializeIRelationshipElement(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends IRelationshipElement> result =
          DeserializeImplementation.tryIRelationshipElementFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static RelationshipElement deserializeRelationshipElement(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends RelationshipElement> result =
          DeserializeImplementation.tryRelationshipElementFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static SubmodelElementList deserializeSubmodelElementList(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends SubmodelElementList> result =
          DeserializeImplementation.trySubmodelElementListFromElement(reader);
    ...
    public static SubmodelElementCollection deserializeSubmodelElementCollection(
      ...
      Result<? extends SubmodelElementCollection> result =
          DeserializeImplementation.trySubmodelElementCollectionFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static IDataElement deserializeIDataElement(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends IDataElement> result =
          DeserializeImplementation.tryIDataElementFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static Property deserializeProperty(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends Property> result = DeserializeImplementation.tryPropertyFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static MultiLanguageProperty deserializeMultiLanguageProperty(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends MultiLanguageProperty> result =
          DeserializeImplementation.tryMultiLanguagePropertyFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static Range deserializeRange(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends Range> result = DeserializeImplementation.tryRangeFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static ReferenceElement deserializeReferenceElement(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends ReferenceElement> result =
          DeserializeImplementation.tryReferenceElementFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static Blob deserializeBlob(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends Blob> result = DeserializeImplementation.tryBlobFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static File deserializeFile(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends File> result = DeserializeImplementation.tryFileFromElement(reader);
    ...
    public static AnnotatedRelationshipElement deserializeAnnotatedRelationshipElement(
      ...
      Result<? extends AnnotatedRelationshipElement> result =
          DeserializeImplementation.tryAnnotatedRelationshipElementFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static Entity deserializeEntity(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends Entity> result = DeserializeImplementation.tryEntityFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static EventPayload deserializeEventPayload(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends EventPayload> result =
          DeserializeImplementation.tryEventPayloadFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static IEventElement deserializeIEventElement(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends IEventElement> result =
          DeserializeImplementation.tryIEventElementFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static BasicEventElement deserializeBasicEventElement(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends BasicEventElement> result =
          DeserializeImplementation.tryBasicEventElementFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static Operation deserializeOperation(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends Operation> result =
          DeserializeImplementation.tryOperationFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static OperationVariable deserializeOperationVariable(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends OperationVariable> result =
          DeserializeImplementation.tryOperationVariableFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static Capability deserializeCapability(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends Capability> result =
          DeserializeImplementation.tryCapabilityFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static ConceptDescription deserializeConceptDescription(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends ConceptDescription> result =
          DeserializeImplementation.tryConceptDescriptionFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static Reference deserializeReference(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends Reference> result =
          DeserializeImplementation.tryReferenceFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static Key deserializeKey(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends Key> result = DeserializeImplementation.tryKeyFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static IAbstractLangString deserializeIAbstractLangString(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends IAbstractLangString> result =
          DeserializeImplementation.tryIAbstractLangStringFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static LangStringNameType deserializeLangStringNameType(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends LangStringNameType> result =
          DeserializeImplementation.tryLangStringNameTypeFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static LangStringTextType deserializeLangStringTextType(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends LangStringTextType> result =
          DeserializeImplementation.tryLangStringTextTypeFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static Environment deserializeEnvironment(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends Environment> result =
          DeserializeImplementation.tryEnvironmentFromElement(reader);
    ...
    public static IDataSpecificationContent deserializeIDataSpecificationContent(
      ...
      Result<? extends IDataSpecificationContent> result =
          DeserializeImplementation.tryIDataSpecificationContentFromElement(reader);
    ...
    public static EmbeddedDataSpecification deserializeEmbeddedDataSpecification(
      ...
      Result<? extends EmbeddedDataSpecification> result =
          DeserializeImplementation.tryEmbeddedDataSpecificationFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static LevelType deserializeLevelType(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends LevelType> result =
          DeserializeImplementation.tryLevelTypeFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static ValueReferencePair deserializeValueReferencePair(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends ValueReferencePair> result =
          DeserializeImplementation.tryValueReferencePairFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static ValueList deserializeValueList(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends ValueList> result =
          DeserializeImplementation.tryValueListFromElement(reader);
     ...
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static LangStringPreferredNameTypeIec61360
        deserializeLangStringPreferredNameTypeIec61360(XMLEventReader reader) {

      DeserializeImplementation.skipStartDocument(reader);
      DeserializeImplementation.skipWhitespaceAndComments(reader);

      Result<? extends LangStringPreferredNameTypeIec61360> result =
          DeserializeImplementation.tryLangStringPreferredNameTypeIec61360FromElement(reader);
    ...
    public static LangStringShortNameTypeIec61360 deserializeLangStringShortNameTypeIec61360(
      ...
      Result<? extends LangStringShortNameTypeIec61360> result =
          DeserializeImplementation.tryLangStringShortNameTypeIec61360FromElement(reader);
    ...
    public static LangStringDefinitionTypeIec61360 deserializeLangStringDefinitionTypeIec61360(
      ...
      Result<? extends LangStringDefinitionTypeIec61360> result =
          DeserializeImplementation.tryLangStringDefinitionTypeIec61360FromElement(reader);
    ...
    public static DataSpecificationIec61360 deserializeDataSpecificationIec61360(
      ...
      Result<? extends DataSpecificationIec61360> result =
          DeserializeImplementation.tryDataSpecificationIec61360FromElement(reader);
  ...
  static class VisitorWithWriter extends AbstractVisitorWithContext<XMLStreamWriter> {

    private boolean topLevel = true;

    private void extensionToSequence(IExtension that, XMLStreamWriter writer) {
      try {
        if (that.getSemanticId().isPresent()) {
          writer.writeStartElement("semanticId");
          if (topLevel) {
            writer.writeNamespace("xmlns", AAS_NAME_SPACE);
            topLevel = false;
          }

          this.referenceToSequence(that.getSemanticId().get(), writer);
      ...
      try {
        if (that.getSupplementalSemanticIds().isPresent()) {
          writer.writeStartElement("supplementalSemanticIds");
          if (topLevel) {
            writer.writeNamespace("xmlns", AAS_NAME_SPACE);
            topLevel = false;
          }
      ...
      try {
        ...
        writer.writeCharacters(that.getName().toString());
        writer.writeEndElement();
      ...
      try {
        if (that.getValueType().isPresent()) {
          ...
          Optional<String> textValueType = Stringification.toString(that.getValueType().get());
      ...
      try {
        if (that.getValue().isPresent()) {
          ...
          writer.writeCharacters(that.getValue().get().toString());
      ...
      try {
        if (that.getRefersTo().isPresent()) {
          writer.writeStartElement("refersTo");
          if (topLevel) {
            writer.writeNamespace("xmlns", AAS_NAME_SPACE);
            topLevel = false;
          }
    ...
    @Override
    public void visitExtension(IExtension that, XMLStreamWriter writer) {
      try {
    ...
    private void administrativeInformationToSequence(
        IAdministrativeInformation that, XMLStreamWriter writer) {
      try {
        if (that.getEmbeddedDataSpecifications().isPresent()) {
          writer.writeStartElement("embeddedDataSpecifications");
          if (topLevel) {
            writer.writeNamespace("xmlns", AAS_NAME_SPACE);
            topLevel = false;
          }
      ...
      try {
        if (that.getVersion().isPresent()) {
          ...
          writer.writeCharacters(that.getVersion().get().toString());
      ...
      try {
        if (that.getRevision().isPresent()) {
          ...
          writer.writeCharacters(that.getRevision().get().toString());
      ...
      try {
        if (that.getCreator().isPresent()) {
          ...
          this.referenceToSequence(that.getCreator().get(), writer);
      ...
      try {
        if (that.getTemplateId().isPresent()) {
          ...
          writer.writeCharacters(that.getTemplateId().get().toString());
    ...
    private void qualifierToSequence(IQualifier that, XMLStreamWriter writer) {
      try {
        if (that.getSemanticId().isPresent()) {
          writer.writeStartElement("semanticId");
          if (topLevel) {
      ...
      try {
        if (that.getKind().isPresent()) {
          ...
          Optional<String> textKind = Stringification.toString(that.getKind().get());
      ...
      try {
        ...
        Optional<String> textValueType = Stringification.toString(that.getValueType());
      ...
      try {
        if (that.getValueId().isPresent()) {
          writer.writeStartElement("valueId");
          if (topLevel) {
            writer.writeNamespace("xmlns", AAS_NAME_SPACE);
            topLevel = false;
          }

          this.referenceToSequence(that.getValueId().get(), writer);
    ...
    @Override
    public void visitQualifier(IQualifier that, XMLStreamWriter writer) {
      try {
    ...
    private void assetAdministrationShellToSequence(
        IAssetAdministrationShell that, XMLStreamWriter writer) {
      try {
      ...
      try {
        if (that.getCategory().isPresent()) {
          ...
          writer.writeCharacters(that.getCategory().get().toString());
      ...
      try {
        if (that.getIdShort().isPresent()) {
          writer.writeStartElement("idShort");
          if (topLevel) {
            writer.writeNamespace("xmlns", AAS_NAME_SPACE);
            topLevel = false;
          }

          writer.writeCharacters(that.getIdShort().get().toString());
      ...
      try {
        if (that.getAdministration().isPresent()) {
          ...
          this.administrativeInformationToSequence(that.getAdministration().get(), writer);
      ...
      try {
        ...
        writer.writeCharacters(that.getId().toString());
        writer.writeEndElement();
      } catch (Exception exception) {
        throw new SerializeException("", exception.getMessage());
      }
      ...
      try {
        if (that.getDerivedFrom().isPresent()) {
          writer.writeStartElement("derivedFrom");
          if (topLevel) {
            writer.writeNamespace("xmlns", AAS_NAME_SPACE);
            topLevel = false;
          }

          this.referenceToSequence(that.getDerivedFrom().get(), writer);
      ...
      try {
        writer.writeStartElement("assetInformation");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
          topLevel = false;
        }

        this.assetInformationToSequence(that.getAssetInformation(), writer);
      ...
      try {
        if (that.getSubmodels().isPresent()) {
          writer.writeStartElement("submodels");
          if (topLevel) {
            writer.writeNamespace("xmlns", AAS_NAME_SPACE);
            topLevel = false;
          }
    ...
    public void visitAssetAdministrationShell(
        IAssetAdministrationShell that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("assetAdministrationShell");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
          topLevel = false;
        }
    ...
    private void assetInformationToSequence(IAssetInformation that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("assetKind");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
          topLevel = false;
        }

        Optional<String> textAssetKind = Stringification.toString(that.getAssetKind());

        if (!textAssetKind.isPresent()) {
          throw new IllegalArgumentException(
              "Invalid literal for the enumeration AssetKind: " + that.getAssetKind().toString());
        }
      ...
      try {
        if (that.getGlobalAssetId().isPresent()) {
          writer.writeStartElement("globalAssetId");
          if (topLevel) {
            writer.writeNamespace("xmlns", AAS_NAME_SPACE);
            topLevel = false;
          }

          writer.writeCharacters(that.getGlobalAssetId().get().toString());
      ...
      try {
        if (that.getSpecificAssetIds().isPresent()) {
          writer.writeStartElement("specificAssetIds");
          if (topLevel) {
            writer.writeNamespace("xmlns", AAS_NAME_SPACE);
            topLevel = false;
          }
      ...
      try {
        if (that.getAssetType().isPresent()) {
          ...
          writer.writeCharacters(that.getAssetType().get().toString());
      ...
      try {
        if (that.getDefaultThumbnail().isPresent()) {
          writer.writeStartElement("defaultThumbnail");
          if (topLevel) {
            writer.writeNamespace("xmlns", AAS_NAME_SPACE);
            topLevel = false;
          }

          this.resourceToSequence(that.getDefaultThumbnail().get(), writer);
    ...
    @Override
    public void visitAssetInformation(IAssetInformation that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("assetInformation");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
        ...
        this.assetInformationToSequence(that, writer);
        writer.writeEndElement();
      } catch (XMLStreamException exception) {
        throw new SerializeException("", exception.getMessage());
      }
    ...
    private void resourceToSequence(IResource that, XMLStreamWriter writer) {
      try {
        ...
        writer.writeCharacters(that.getPath().toString());
        writer.writeEndElement();
      } catch (Exception exception) {
        throw new SerializeException("", exception.getMessage());
      }
      ...
      try {
        if (that.getContentType().isPresent()) {
          ...
          writer.writeCharacters(that.getContentType().get().toString());
    ...
    @Override
    public void visitResource(IResource that, XMLStreamWriter writer) {
      try {
    ...
    private void specificAssetIdToSequence(ISpecificAssetId that, XMLStreamWriter writer) {
      try {
        if (that.getSemanticId().isPresent()) {
          writer.writeStartElement("semanticId");
          if (topLevel) {
      ...
      try {
        ...
        writer.writeCharacters(that.getValue().toString());
        writer.writeEndElement();
      } catch (Exception exception) {
        throw new SerializeException("", exception.getMessage());
      }
      ...
      try {
        if (that.getExternalSubjectId().isPresent()) {
          writer.writeStartElement("externalSubjectId");
          if (topLevel) {
            writer.writeNamespace("xmlns", AAS_NAME_SPACE);
            topLevel = false;
          }

          this.referenceToSequence(that.getExternalSubjectId().get(), writer);
    ...
    @Override
    public void visitSpecificAssetId(ISpecificAssetId that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("specificAssetId");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
          topLevel = false;
        }
    ...
    private void submodelToSequence(ISubmodel that, XMLStreamWriter writer) {
      try {
        if (that.getExtensions().isPresent()) {
          writer.writeStartElement("extensions");
          if (topLevel) {
      ...
      try {
        if (that.getQualifiers().isPresent()) {
          writer.writeStartElement("qualifiers");
          if (topLevel) {
            writer.writeNamespace("xmlns", AAS_NAME_SPACE);
            topLevel = false;
          }
      ...
      try {
        if (that.getSubmodelElements().isPresent()) {
          writer.writeStartElement("submodelElements");
          if (topLevel) {
            writer.writeNamespace("xmlns", AAS_NAME_SPACE);
            topLevel = false;
          }
    ...
    @Override
    public void visitSubmodel(ISubmodel that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("submodel");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
          topLevel = false;
        }
    ...
    private void relationshipElementToSequence(IRelationshipElement that, XMLStreamWriter writer) {
      try {
        if (that.getExtensions().isPresent()) {
          writer.writeStartElement("extensions");
          if (topLevel) {
      ...
      try {
        ...
        this.referenceToSequence(that.getFirst(), writer);
      ...
      try {
        ...
        this.referenceToSequence(that.getSecond(), writer);
    ...
    @Override
    public void visitRelationshipElement(IRelationshipElement that, XMLStreamWriter writer) {
      try {
    ...
    private void submodelElementListToSequence(ISubmodelElementList that, XMLStreamWriter writer) {
      try {
        if (that.getExtensions().isPresent()) {
          writer.writeStartElement("extensions");
          if (topLevel) {
      ...
      try {
        if (that.getOrderRelevant().isPresent()) {
          writer.writeStartElement("orderRelevant");
          if (topLevel) {
            writer.writeNamespace("xmlns", AAS_NAME_SPACE);
            topLevel = false;
          }

          writer.writeCharacters(that.getOrderRelevant().get().toString());
      ...
      try {
        if (that.getSemanticIdListElement().isPresent()) {
          writer.writeStartElement("semanticIdListElement");
          if (topLevel) {
            writer.writeNamespace("xmlns", AAS_NAME_SPACE);
            topLevel = false;
          }

          this.referenceToSequence(that.getSemanticIdListElement().get(), writer);
      ...
      try {
        writer.writeStartElement("typeValueListElement");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
          topLevel = false;
        }

        Optional<String> textTypeValueListElement =
            Stringification.toString(that.getTypeValueListElement());
      ...
      try {
        if (that.getValueTypeListElement().isPresent()) {
          writer.writeStartElement("valueTypeListElement");
          if (topLevel) {
            writer.writeNamespace("xmlns", AAS_NAME_SPACE);
            topLevel = false;
          }

          Optional<String> textValueTypeListElement =
              Stringification.toString(that.getValueTypeListElement().get());
    ...
    @Override
    public void visitSubmodelElementList(ISubmodelElementList that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("submodelElementList");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
          topLevel = false;
        }
    ...
    private void submodelElementCollectionToSequence(
        ISubmodelElementCollection that, XMLStreamWriter writer) {
      try {
        if (that.getExtensions().isPresent()) {
          writer.writeStartElement("extensions");
          if (topLevel) {
    ...
    public void visitSubmodelElementCollection(
        ISubmodelElementCollection that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("submodelElementCollection");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
          topLevel = false;
        }
        this.submodelElementCollectionToSequence(that, writer);
        writer.writeEndElement();
      } catch (XMLStreamException exception) {
        throw new SerializeException("", exception.getMessage());
      }
    ...
    private void propertyToSequence(IProperty that, XMLStreamWriter writer) {
      try {
        if (that.getExtensions().isPresent()) {
          writer.writeStartElement("extensions");
          if (topLevel) {
    ...
    @Override
    public void visitProperty(IProperty that, XMLStreamWriter writer) {
      try {
    ...
    private void multiLanguagePropertyToSequence(
        IMultiLanguageProperty that, XMLStreamWriter writer) {
      try {
        if (that.getExtensions().isPresent()) {
          writer.writeStartElement("extensions");
          if (topLevel) {
    ...
    @Override
    public void visitMultiLanguageProperty(IMultiLanguageProperty that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("multiLanguageProperty");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
          topLevel = false;
        }
        this.multiLanguagePropertyToSequence(that, writer);
        writer.writeEndElement();
      } catch (XMLStreamException exception) {
        throw new SerializeException("", exception.getMessage());
      }
    ...
    private void rangeToSequence(IRange that, XMLStreamWriter writer) {
      try {
        if (that.getExtensions().isPresent()) {
          writer.writeStartElement("extensions");
          if (topLevel) {
      ...
      try {
        if (that.getMin().isPresent()) {
          ...
          writer.writeCharacters(that.getMin().get().toString());
      ...
      try {
        if (that.getMax().isPresent()) {
          ...
          writer.writeCharacters(that.getMax().get().toString());
    ...
    @Override
    public void visitRange(IRange that, XMLStreamWriter writer) {
      try {
    ...
    private void referenceElementToSequence(IReferenceElement that, XMLStreamWriter writer) {
      try {
        if (that.getExtensions().isPresent()) {
          writer.writeStartElement("extensions");
          if (topLevel) {
      ...
      try {
        if (that.getValue().isPresent()) {
          ...
          this.referenceToSequence(that.getValue().get(), writer);
    ...
    @Override
    public void visitReferenceElement(IReferenceElement that, XMLStreamWriter writer) {
      try {
    ...
    private void blobToSequence(IBlob that, XMLStreamWriter writer) {
      try {
        if (that.getExtensions().isPresent()) {
          writer.writeStartElement("extensions");
          if (topLevel) {
      ...
      try {
        if (that.getValue().isPresent()) {
          ...
          String theB64Value = Base64.getEncoder().encodeToString(that.getValue().get());
      ...
      try {
        ...
        writer.writeCharacters(that.getContentType().toString());
        writer.writeEndElement();
      } catch (Exception exception) {
        throw new SerializeException("", exception.getMessage());
      }
    ...
    @Override
    public void visitBlob(IBlob that, XMLStreamWriter writer) {
      try {
    ...
    private void fileToSequence(IFile that, XMLStreamWriter writer) {
      try {
        if (that.getExtensions().isPresent()) {
          writer.writeStartElement("extensions");
          if (topLevel) {
    ...
    @Override
    public void visitFile(IFile that, XMLStreamWriter writer) {
      try {
        ...
        this.fileToSequence(that, writer);
        writer.writeEndElement();
      } catch (XMLStreamException exception) {
        throw new SerializeException("", exception.getMessage());
      }
    ...
    private void annotatedRelationshipElementToSequence(
        IAnnotatedRelationshipElement that, XMLStreamWriter writer) {
      try {
        if (that.getExtensions().isPresent()) {
          writer.writeStartElement("extensions");
          if (topLevel) {
    ...
    public void visitAnnotatedRelationshipElement(
        IAnnotatedRelationshipElement that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("annotatedRelationshipElement");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
          topLevel = false;
        }
        this.annotatedRelationshipElementToSequence(that, writer);
        writer.writeEndElement();
      } catch (XMLStreamException exception) {
        throw new SerializeException("", exception.getMessage());
      }
    ...
    private void entityToSequence(IEntity that, XMLStreamWriter writer) {
      try {
        if (that.getExtensions().isPresent()) {
          writer.writeStartElement("extensions");
          if (topLevel) {
      ...
      try {
        ...
        Optional<String> textEntityType = Stringification.toString(that.getEntityType());

        if (!textEntityType.isPresent()) {
          throw new IllegalArgumentException(
              "Invalid literal for the enumeration EntityType: " + that.getEntityType().toString());
        }
    ...
    @Override
    public void visitEntity(IEntity that, XMLStreamWriter writer) {
      try {
        ...
        this.entityToSequence(that, writer);
        writer.writeEndElement();
      } catch (XMLStreamException exception) {
        throw new SerializeException("", exception.getMessage());
      }
    ...
    private void eventPayloadToSequence(IEventPayload that, XMLStreamWriter writer) {
      try {
        ...
        this.referenceToSequence(that.getSource(), writer);
      ...
      try {
        if (that.getSourceSemanticId().isPresent()) {
          writer.writeStartElement("sourceSemanticId");
          if (topLevel) {
            writer.writeNamespace("xmlns", AAS_NAME_SPACE);
            topLevel = false;
          }

          this.referenceToSequence(that.getSourceSemanticId().get(), writer);
      ...
      try {
        writer.writeStartElement("observableReference");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
          topLevel = false;
        }

        this.referenceToSequence(that.getObservableReference(), writer);
      ...
      try {
        if (that.getObservableSemanticId().isPresent()) {
          writer.writeStartElement("observableSemanticId");
          if (topLevel) {
            writer.writeNamespace("xmlns", AAS_NAME_SPACE);
            topLevel = false;
          }

          this.referenceToSequence(that.getObservableSemanticId().get(), writer);
      ...
      try {
        if (that.getTopic().isPresent()) {
          ...
          writer.writeCharacters(that.getTopic().get().toString());
      ...
      try {
        if (that.getSubjectId().isPresent()) {
          ...
          this.referenceToSequence(that.getSubjectId().get(), writer);
      ...
      try {
        ...
        writer.writeCharacters(that.getTimeStamp().toString());
        writer.writeEndElement();
      } catch (Exception exception) {
        throw new SerializeException("", exception.getMessage());
      }
      ...
      try {
        if (that.getPayload().isPresent()) {
          ...
          String theB64Payload = Base64.getEncoder().encodeToString(that.getPayload().get());
    ...
    @Override
    public void visitEventPayload(IEventPayload that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("eventPayload");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
          topLevel = false;
        }
    ...
    private void basicEventElementToSequence(IBasicEventElement that, XMLStreamWriter writer) {
      try {
        if (that.getExtensions().isPresent()) {
          writer.writeStartElement("extensions");
          if (topLevel) {
      ...
      try {
        writer.writeStartElement("observed");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
          topLevel = false;
        }

        this.referenceToSequence(that.getObserved(), writer);
      ...
      try {
        ...
        Optional<String> textDirection = Stringification.toString(that.getDirection());

        if (!textDirection.isPresent()) {
          throw new IllegalArgumentException(
              "Invalid literal for the enumeration Direction: " + that.getDirection().toString());
        }
      ...
      try {
        ...
        Optional<String> textState = Stringification.toString(that.getState());

        if (!textState.isPresent()) {
          throw new IllegalArgumentException(
              "Invalid literal for the enumeration StateOfEvent: " + that.getState().toString());
        }
      ...
      try {
        if (that.getMessageTopic().isPresent()) {
          writer.writeStartElement("messageTopic");
          if (topLevel) {
            writer.writeNamespace("xmlns", AAS_NAME_SPACE);
            topLevel = false;
          }

          writer.writeCharacters(that.getMessageTopic().get().toString());
      ...
      try {
        if (that.getMessageBroker().isPresent()) {
          writer.writeStartElement("messageBroker");
          if (topLevel) {
            writer.writeNamespace("xmlns", AAS_NAME_SPACE);
            topLevel = false;
          }

          this.referenceToSequence(that.getMessageBroker().get(), writer);
      ...
      try {
        if (that.getLastUpdate().isPresent()) {
          ...
          writer.writeCharacters(that.getLastUpdate().get().toString());
      ...
      try {
        if (that.getMinInterval().isPresent()) {
          writer.writeStartElement("minInterval");
          if (topLevel) {
            writer.writeNamespace("xmlns", AAS_NAME_SPACE);
            topLevel = false;
          }

          writer.writeCharacters(that.getMinInterval().get().toString());
      ...
      try {
        if (that.getMaxInterval().isPresent()) {
          writer.writeStartElement("maxInterval");
          if (topLevel) {
            writer.writeNamespace("xmlns", AAS_NAME_SPACE);
            topLevel = false;
          }

          writer.writeCharacters(that.getMaxInterval().get().toString());
    ...
    @Override
    public void visitBasicEventElement(IBasicEventElement that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("basicEventElement");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
          topLevel = false;
        }
    ...
    private void operationToSequence(IOperation that, XMLStreamWriter writer) {
      try {
        if (that.getExtensions().isPresent()) {
          writer.writeStartElement("extensions");
          if (topLevel) {
      ...
      try {
        if (that.getInoutputVariables().isPresent()) {
          writer.writeStartElement("inoutputVariables");
          if (topLevel) {
            writer.writeNamespace("xmlns", AAS_NAME_SPACE);
            topLevel = false;
          }
    ...
    @Override
    public void visitOperation(IOperation that, XMLStreamWriter writer) {
      try {
    ...
    private void operationVariableToSequence(IOperationVariable that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("value");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
        ...
        this.visit(that.getValue(), writer);
    ...
    @Override
    public void visitOperationVariable(IOperationVariable that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("operationVariable");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
          topLevel = false;
        }
    ...
    private void capabilityToSequence(ICapability that, XMLStreamWriter writer) {
      try {
        if (that.getExtensions().isPresent()) {
          writer.writeStartElement("extensions");
          if (topLevel) {
    ...
    @Override
    public void visitCapability(ICapability that, XMLStreamWriter writer) {
      try {
    ...
    private void conceptDescriptionToSequence(IConceptDescription that, XMLStreamWriter writer) {
      try {
        if (that.getExtensions().isPresent()) {
          writer.writeStartElement("extensions");
          if (topLevel) {
      ...
      try {
        if (that.getIsCaseOf().isPresent()) {
          writer.writeStartElement("isCaseOf");
          if (topLevel) {
            writer.writeNamespace("xmlns", AAS_NAME_SPACE);
            topLevel = false;
          }
    ...
    @Override
    public void visitConceptDescription(IConceptDescription that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("conceptDescription");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
          topLevel = false;
        }
    ...
    private void referenceToSequence(IReference that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("type");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
        ...
        Optional<String> textType = Stringification.toString(that.getType());

        if (!textType.isPresent()) {
          throw new IllegalArgumentException(
              "Invalid literal for the enumeration ReferenceTypes: " + that.getType().toString());
        }
      ...
      try {
        if (that.getReferredSemanticId().isPresent()) {
          writer.writeStartElement("referredSemanticId");
          if (topLevel) {
            writer.writeNamespace("xmlns", AAS_NAME_SPACE);
            topLevel = false;
          }

          this.referenceToSequence(that.getReferredSemanticId().get(), writer);
    ...
    @Override
    public void visitReference(IReference that, XMLStreamWriter writer) {
      try {
    ...
    private void keyToSequence(IKey that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("type");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
        ...
        if (!textType.isPresent()) {
          throw new IllegalArgumentException(
              "Invalid literal for the enumeration KeyTypes: " + that.getType().toString());
        }
    ...
    @Override
    public void visitKey(IKey that, XMLStreamWriter writer) {
      try {
    ...
    private void langStringNameTypeToSequence(ILangStringNameType that, XMLStreamWriter writer) {
      try {
        ...
        writer.writeCharacters(that.getLanguage().toString());
        writer.writeEndElement();
      } catch (Exception exception) {
        throw new SerializeException("", exception.getMessage());
      }
      ...
      try {
        ...
        writer.writeCharacters(that.getText().toString());
        writer.writeEndElement();
      } catch (Exception exception) {
        throw new SerializeException("", exception.getMessage());
      }
    ...
    @Override
    public void visitLangStringNameType(ILangStringNameType that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("langStringNameType");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
          topLevel = false;
        }
    ...
    private void langStringTextTypeToSequence(ILangStringTextType that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("language");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
    ...
    @Override
    public void visitLangStringTextType(ILangStringTextType that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("langStringTextType");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
          topLevel = false;
        }
        this.langStringTextTypeToSequence(that, writer);
        writer.writeEndElement();
      } catch (XMLStreamException exception) {
        throw new SerializeException("", exception.getMessage());
      }
    ...
    private void environmentToSequence(IEnvironment that, XMLStreamWriter writer) {
      try {
        if (that.getAssetAdministrationShells().isPresent()) {
          writer.writeStartElement("assetAdministrationShells");
          if (topLevel) {
            writer.writeNamespace("xmlns", AAS_NAME_SPACE);
            topLevel = false;
          }
      ...
      try {
        if (that.getConceptDescriptions().isPresent()) {
          writer.writeStartElement("conceptDescriptions");
          if (topLevel) {
            writer.writeNamespace("xmlns", AAS_NAME_SPACE);
            topLevel = false;
          }
    ...
    @Override
    public void visitEnvironment(IEnvironment that, XMLStreamWriter writer) {
      try {
    ...
    public void visitEmbeddedDataSpecification(
        IEmbeddedDataSpecification that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("embeddedDataSpecification");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
          topLevel = false;
        }
    ...
    private void levelTypeToSequence(ILevelType that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("min");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
        ...
        writer.writeCharacters(that.getMin().toString());
        writer.writeEndElement();
      } catch (Exception exception) {
        throw new SerializeException("", exception.getMessage());
      }
      ...
      try {
        ...
        writer.writeCharacters(that.getNom().toString());
        writer.writeEndElement();
      } catch (Exception exception) {
        throw new SerializeException("", exception.getMessage());
      }
      ...
      try {
        ...
        writer.writeCharacters(that.getTyp().toString());
        writer.writeEndElement();
      } catch (Exception exception) {
        throw new SerializeException("", exception.getMessage());
      }
      ...
      try {
        ...
        writer.writeCharacters(that.getMax().toString());
        writer.writeEndElement();
      } catch (Exception exception) {
        throw new SerializeException("", exception.getMessage());
      }
    ...
    @Override
    public void visitLevelType(ILevelType that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("levelType");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
          topLevel = false;
        }
    ...
    private void valueReferencePairToSequence(IValueReferencePair that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("value");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
      ...
      try {
        ...
        this.referenceToSequence(that.getValueId(), writer);
    ...
    @Override
    public void visitValueReferencePair(IValueReferencePair that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("valueReferencePair");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
          topLevel = false;
        }
    ...
    private void valueListToSequence(IValueList that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("valueReferencePairs");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
          topLevel = false;
        }
    ...
    @Override
    public void visitValueList(IValueList that, XMLStreamWriter writer) {
      try {
    ...
    private void langStringPreferredNameTypeIec61360ToSequence(
        ILangStringPreferredNameTypeIec61360 that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("language");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
    ...
    public void visitLangStringPreferredNameTypeIec61360(
        ILangStringPreferredNameTypeIec61360 that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("langStringPreferredNameTypeIec61360");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
          topLevel = false;
        }
    ...
    private void langStringShortNameTypeIec61360ToSequence(
        ILangStringShortNameTypeIec61360 that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("language");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
    ...
    public void visitLangStringShortNameTypeIec61360(
        ILangStringShortNameTypeIec61360 that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("langStringShortNameTypeIec61360");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
          topLevel = false;
        }
    ...
    private void langStringDefinitionTypeIec61360ToSequence(
        ILangStringDefinitionTypeIec61360 that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("language");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
    ...
    public void visitLangStringDefinitionTypeIec61360(
        ILangStringDefinitionTypeIec61360 that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("langStringDefinitionTypeIec61360");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
          topLevel = false;
        }
    ...
    private void dataSpecificationIec61360ToSequence(
        IDataSpecificationIec61360 that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("preferredName");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
          topLevel = false;
        }
      ...
      try {
        if (that.getUnit().isPresent()) {
          ...
          writer.writeCharacters(that.getUnit().get().toString());
      ...
      try {
        if (that.getUnitId().isPresent()) {
          ...
          this.referenceToSequence(that.getUnitId().get(), writer);
      ...
      try {
        if (that.getSourceOfDefinition().isPresent()) {
          writer.writeStartElement("sourceOfDefinition");
          if (topLevel) {
            writer.writeNamespace("xmlns", AAS_NAME_SPACE);
            topLevel = false;
          }

          writer.writeCharacters(that.getSourceOfDefinition().get().toString());
      ...
      try {
        if (that.getSymbol().isPresent()) {
          ...
          writer.writeCharacters(that.getSymbol().get().toString());
      ...
      try {
        if (that.getDataType().isPresent()) {
          ...
          Optional<String> textDataType = Stringification.toString(that.getDataType().get());
      ...
      try {
        if (that.getValueFormat().isPresent()) {
          writer.writeStartElement("valueFormat");
          if (topLevel) {
            writer.writeNamespace("xmlns", AAS_NAME_SPACE);
            topLevel = false;
          }

          writer.writeCharacters(that.getValueFormat().get().toString());
      ...
      try {
        if (that.getValueList().isPresent()) {
          ...
          this.valueListToSequence(that.getValueList().get(), writer);
      ...
      try {
        if (that.getLevelType().isPresent()) {
          ...
          this.levelTypeToSequence(that.getLevelType().get(), writer);
    ...
    public void visitDataSpecificationIec61360(
        IDataSpecificationIec61360 that, XMLStreamWriter writer) {
      try {
        writer.writeStartElement("dataSpecificationIec61360");
        if (topLevel) {
          writer.writeNamespace("xmlns", AAS_NAME_SPACE);
          topLevel = false;
        }
        this.dataSpecificationIec61360ToSequence(that, writer);
        writer.writeEndElement();
      } catch (XMLStreamException exception) {
        throw new SerializeException("", exception.getMessage());
      }
  ...
  public static class Serialize {
    ...
    public static void to(IClass that, XMLStreamWriter writer) throws SerializeException {
      VisitorWithWriter visitor = new VisitorWithWriter();
      visitor.visit(that, writer);
    }
  }
}
