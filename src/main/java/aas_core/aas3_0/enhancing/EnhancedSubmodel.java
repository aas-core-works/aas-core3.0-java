...
public class EnhancedSubmodel<EnhancementT> extends Enhanced<EnhancementT> implements ISubmodel {
  private final ISubmodel instance;

  public EnhancedSubmodel(ISubmodel instance, EnhancementT enhancement) {
    super(enhancement);
