...
public class EnhancedReference<EnhancementT> extends Enhanced<EnhancementT> implements IReference {
  private final IReference instance;

  public EnhancedReference(IReference instance, EnhancementT enhancement) {
    super(enhancement);
