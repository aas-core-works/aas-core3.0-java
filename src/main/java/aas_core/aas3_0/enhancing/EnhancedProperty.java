...
public class EnhancedProperty<EnhancementT> extends Enhanced<EnhancementT> implements IProperty {
  private final IProperty instance;

  public EnhancedProperty(IProperty instance, EnhancementT enhancement) {
    super(enhancement);
