...
public class EnhancedAnnotatedRelationshipElement<EnhancementT> extends Enhanced<EnhancementT>
  ...
  public EnhancedAnnotatedRelationshipElement(
      IAnnotatedRelationshipElement instance, EnhancementT enhancement) {
    super(enhancement);
