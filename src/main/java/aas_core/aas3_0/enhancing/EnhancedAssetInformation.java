...
public class EnhancedAssetInformation<EnhancementT> extends Enhanced<EnhancementT>
    implements IAssetInformation {
  private final IAssetInformation instance;

  public EnhancedAssetInformation(IAssetInformation instance, EnhancementT enhancement) {
    super(enhancement);
