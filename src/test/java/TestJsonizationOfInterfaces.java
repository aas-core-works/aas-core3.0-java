...
public class TestJsonizationOfInterfaces {
  ...
  public void testRoundTripIHasSemanticsFromRelationshipElement() throws IOException {
    ...
    final IHasSemantics anotherInstance =
        Jsonization.Deserialize.deserializeIHasSemantics(jsonObject);
  ...
  public void testRoundTripIHasExtensionsFromRelationshipElement() throws IOException {
    ...
    final IHasExtensions anotherInstance =
        Jsonization.Deserialize.deserializeIHasExtensions(jsonObject);
    final JsonNode anotherJsonObject = Jsonization.Serialize.toJsonObject(anotherInstance);
    assertEquals(
        mapper.readTree(jsonObject.toString()), mapper.readTree(anotherJsonObject.toString()));
  ...
  public void testRoundTripIIdentifiableFromAssetAdministrationShell() throws IOException {
    ...
    final IIdentifiable anotherInstance =
        Jsonization.Deserialize.deserializeIIdentifiable(jsonObject);
    final JsonNode anotherJsonObject = Jsonization.Serialize.toJsonObject(anotherInstance);
    assertEquals(
        mapper.readTree(jsonObject.toString()), mapper.readTree(anotherJsonObject.toString()));
  ...
  public void testRoundTripIHasDataSpecificationFromRelationshipElement() throws IOException {
    ...
    final IHasDataSpecification anotherInstance =
        Jsonization.Deserialize.deserializeIHasDataSpecification(jsonObject);
    final JsonNode anotherJsonObject = Jsonization.Serialize.toJsonObject(anotherInstance);
    assertEquals(
        mapper.readTree(jsonObject.toString()), mapper.readTree(anotherJsonObject.toString()));
  ...
  public void testRoundTripIQualifiableFromRelationshipElement() throws IOException {
    ...
    final IQualifiable anotherInstance =
        Jsonization.Deserialize.deserializeIQualifiable(jsonObject);
    final JsonNode anotherJsonObject = Jsonization.Serialize.toJsonObject(anotherInstance);
    assertEquals(
        mapper.readTree(jsonObject.toString()), mapper.readTree(anotherJsonObject.toString()));
  ...
  public void testRoundTripISubmodelElementFromRelationshipElement() throws IOException {
    ...
    final ISubmodelElement anotherInstance =
        Jsonization.Deserialize.deserializeISubmodelElement(jsonObject);
    final JsonNode anotherJsonObject = Jsonization.Serialize.toJsonObject(anotherInstance);
    assertEquals(
        mapper.readTree(jsonObject.toString()), mapper.readTree(anotherJsonObject.toString()));
  ...
  public void testRoundTripIRelationshipElementFromAnnotatedRelationshipElement()
    ...
    final IRelationshipElement anotherInstance =
        Jsonization.Deserialize.deserializeIRelationshipElement(jsonObject);
    final JsonNode anotherJsonObject = Jsonization.Serialize.toJsonObject(anotherInstance);
    assertEquals(
        mapper.readTree(jsonObject.toString()), mapper.readTree(anotherJsonObject.toString()));
  ...
  public void testRoundTripIDataElementFromBlob() throws IOException {
    ...
    final IDataElement anotherInstance =
        Jsonization.Deserialize.deserializeIDataElement(jsonObject);
    final JsonNode anotherJsonObject = Jsonization.Serialize.toJsonObject(anotherInstance);
    assertEquals(
        mapper.readTree(jsonObject.toString()), mapper.readTree(anotherJsonObject.toString()));
  ...
  public void testRoundTripIEventElementFromBasicEventElement() throws IOException {
    ...
    final IEventElement anotherInstance =
        Jsonization.Deserialize.deserializeIEventElement(jsonObject);
    final JsonNode anotherJsonObject = Jsonization.Serialize.toJsonObject(anotherInstance);
    assertEquals(
        mapper.readTree(jsonObject.toString()), mapper.readTree(anotherJsonObject.toString()));
  ...
  public void testRoundTripIDataSpecificationContentFromDataSpecificationIec61360()
    ...
    final IDataSpecificationContent anotherInstance =
        Jsonization.Deserialize.deserializeIDataSpecificationContent(jsonObject);
    final JsonNode anotherJsonObject = Jsonization.Serialize.toJsonObject(anotherInstance);
    assertEquals(
        mapper.readTree(jsonObject.toString()), mapper.readTree(anotherJsonObject.toString()));
