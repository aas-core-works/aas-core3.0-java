...
public class TestVerificationOfEnums {
  ...
  public void testModellingKindValid() {
    final List<Reporting.Error> errors =
        Verification.verifyModellingKind(ModellingKind.TEMPLATE).collect(Collectors.toList());
  ...
  public void testQualifierKindValid() {
    final List<Reporting.Error> errors =
        Verification.verifyQualifierKind(QualifierKind.VALUE_QUALIFIER)
  ...
  public void testAssetKindValid() {
    final List<Reporting.Error> errors =
        Verification.verifyAssetKind(AssetKind.TYPE).collect(Collectors.toList());
    assertTrue(errors.isEmpty());
  ...
  public void testAasSubmodelElementsValid() {
    final List<Reporting.Error> errors =
        Verification.verifyAasSubmodelElements(AasSubmodelElements.ANNOTATED_RELATIONSHIP_ELEMENT)
            .collect(Collectors.toList());
    assertTrue(errors.isEmpty());
  ...
  public void testEntityTypeValid() {
    final List<Reporting.Error> errors =
        Verification.verifyEntityType(EntityType.CO_MANAGED_ENTITY).collect(Collectors.toList());
    assertTrue(errors.isEmpty());
  ...
  public void testDirectionValid() {
    final List<Reporting.Error> errors =
        Verification.verifyDirection(Direction.INPUT).collect(Collectors.toList());
    assertTrue(errors.isEmpty());
  ...
  public void testStateOfEventValid() {
    final List<Reporting.Error> errors =
        Verification.verifyStateOfEvent(StateOfEvent.ON).collect(Collectors.toList());
    assertTrue(errors.isEmpty());
  ...
  public void testReferenceTypesValid() {
    final List<Reporting.Error> errors =
        Verification.verifyReferenceTypes(ReferenceTypes.EXTERNAL_REFERENCE)
            .collect(Collectors.toList());
    assertTrue(errors.isEmpty());
  ...
  public void testKeyTypesValid() {
    final List<Reporting.Error> errors =
        Verification.verifyKeyTypes(KeyTypes.ANNOTATED_RELATIONSHIP_ELEMENT)
            .collect(Collectors.toList());
    assertTrue(errors.isEmpty());
  ...
  public void testDataTypeDefXsdValid() {
    final List<Reporting.Error> errors =
        Verification.verifyDataTypeDefXsd(DataTypeDefXsd.ANY_URI).collect(Collectors.toList());
    assertTrue(errors.isEmpty());
  ...
  public void testDataTypeIec61360Valid() {
    final List<Reporting.Error> errors =
        Verification.verifyDataTypeIec61360(DataTypeIec61360.DATE).collect(Collectors.toList());
    assertTrue(errors.isEmpty());
