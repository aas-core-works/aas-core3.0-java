...
/**
 * Test de/serialization of classes contained in a container outside of that container.
 *
 * <p>This is necessary so that we also test the methods that directly de/serialize an instance in
 * rare use cases where it does not reside within a container such as {@link Environment}.
 */
public class TestJsonizationOfConcreteClassesOutsideContainer {
  ...
  public void testRoundTripExtension() throws IOException {
    ...
    assertEquals(
        mapper.readTree(jsonObject.toString()), mapper.readTree(anotherJsonObject.toString()));
  ...
  public void testRoundTripAdministrativeInformation() throws IOException {
    ...
    final AdministrativeInformation anotherInstance =
        Jsonization.Deserialize.deserializeAdministrativeInformation(jsonObject);
    final JsonNode anotherJsonObject = Jsonization.Serialize.toJsonObject(anotherInstance);
    assertEquals(
        mapper.readTree(jsonObject.toString()), mapper.readTree(anotherJsonObject.toString()));
  ...
  public void testRoundTripAssetAdministrationShell() throws IOException {
    ...
    final AssetAdministrationShell anotherInstance =
        Jsonization.Deserialize.deserializeAssetAdministrationShell(jsonObject);
    final JsonNode anotherJsonObject = Jsonization.Serialize.toJsonObject(anotherInstance);
    assertEquals(
        mapper.readTree(jsonObject.toString()), mapper.readTree(anotherJsonObject.toString()));
  ...
  public void testRoundTripAssetInformation() throws IOException {
    ...
    final AssetInformation anotherInstance =
        Jsonization.Deserialize.deserializeAssetInformation(jsonObject);
    final JsonNode anotherJsonObject = Jsonization.Serialize.toJsonObject(anotherInstance);
    assertEquals(
        mapper.readTree(jsonObject.toString()), mapper.readTree(anotherJsonObject.toString()));
  ...
  public void testRoundTripSpecificAssetId() throws IOException {
    ...
    final SpecificAssetId anotherInstance =
        Jsonization.Deserialize.deserializeSpecificAssetId(jsonObject);
    final JsonNode anotherJsonObject = Jsonization.Serialize.toJsonObject(anotherInstance);
    assertEquals(
        mapper.readTree(jsonObject.toString()), mapper.readTree(anotherJsonObject.toString()));
  ...
  public void testRoundTripRelationshipElement() throws IOException {
    ...
    final RelationshipElement anotherInstance =
        Jsonization.Deserialize.deserializeRelationshipElement(jsonObject);
    final JsonNode anotherJsonObject = Jsonization.Serialize.toJsonObject(anotherInstance);
    assertEquals(
        mapper.readTree(jsonObject.toString()), mapper.readTree(anotherJsonObject.toString()));
  ...
  public void testRoundTripSubmodelElementList() throws IOException {
    ...
    final SubmodelElementList anotherInstance =
        Jsonization.Deserialize.deserializeSubmodelElementList(jsonObject);
    final JsonNode anotherJsonObject = Jsonization.Serialize.toJsonObject(anotherInstance);
    assertEquals(
        mapper.readTree(jsonObject.toString()), mapper.readTree(anotherJsonObject.toString()));
  ...
  public void testRoundTripSubmodelElementCollection() throws IOException {
    ...
    final SubmodelElementCollection anotherInstance =
        Jsonization.Deserialize.deserializeSubmodelElementCollection(jsonObject);
    final JsonNode anotherJsonObject = Jsonization.Serialize.toJsonObject(anotherInstance);
    assertEquals(
        mapper.readTree(jsonObject.toString()), mapper.readTree(anotherJsonObject.toString()));
  ...
  public void testRoundTripMultiLanguageProperty() throws IOException {
    ...
    final MultiLanguageProperty anotherInstance =
        Jsonization.Deserialize.deserializeMultiLanguageProperty(jsonObject);
    final JsonNode anotherJsonObject = Jsonization.Serialize.toJsonObject(anotherInstance);
    assertEquals(
        mapper.readTree(jsonObject.toString()), mapper.readTree(anotherJsonObject.toString()));
  ...
  public void testRoundTripReferenceElement() throws IOException {
    ...
    final ReferenceElement anotherInstance =
        Jsonization.Deserialize.deserializeReferenceElement(jsonObject);
    final JsonNode anotherJsonObject = Jsonization.Serialize.toJsonObject(anotherInstance);
    assertEquals(
        mapper.readTree(jsonObject.toString()), mapper.readTree(anotherJsonObject.toString()));
  ...
  public void testRoundTripAnnotatedRelationshipElement() throws IOException {
    ...
    final AnnotatedRelationshipElement anotherInstance =
        Jsonization.Deserialize.deserializeAnnotatedRelationshipElement(jsonObject);
    final JsonNode anotherJsonObject = Jsonization.Serialize.toJsonObject(anotherInstance);
    assertEquals(
        mapper.readTree(jsonObject.toString()), mapper.readTree(anotherJsonObject.toString()));
  ...
  public void testRoundTripBasicEventElement() throws IOException {
    ...
    final BasicEventElement anotherInstance =
        Jsonization.Deserialize.deserializeBasicEventElement(jsonObject);
    final JsonNode anotherJsonObject = Jsonization.Serialize.toJsonObject(anotherInstance);
    assertEquals(
        mapper.readTree(jsonObject.toString()), mapper.readTree(anotherJsonObject.toString()));
  ...
  public void testRoundTripOperationVariable() throws IOException {
    ...
    final OperationVariable anotherInstance =
        Jsonization.Deserialize.deserializeOperationVariable(jsonObject);
    final JsonNode anotherJsonObject = Jsonization.Serialize.toJsonObject(anotherInstance);
    assertEquals(
        mapper.readTree(jsonObject.toString()), mapper.readTree(anotherJsonObject.toString()));
  ...
  public void testRoundTripConceptDescription() throws IOException {
    ...
    final ConceptDescription anotherInstance =
        Jsonization.Deserialize.deserializeConceptDescription(jsonObject);
    final JsonNode anotherJsonObject = Jsonization.Serialize.toJsonObject(anotherInstance);
    assertEquals(
        mapper.readTree(jsonObject.toString()), mapper.readTree(anotherJsonObject.toString()));
  ...
  public void testRoundTripLangStringNameType() throws IOException {
    ...
    final LangStringNameType anotherInstance =
        Jsonization.Deserialize.deserializeLangStringNameType(jsonObject);
    final JsonNode anotherJsonObject = Jsonization.Serialize.toJsonObject(anotherInstance);
    assertEquals(
        mapper.readTree(jsonObject.toString()), mapper.readTree(anotherJsonObject.toString()));
  ...
  public void testRoundTripLangStringTextType() throws IOException {
    ...
    final LangStringTextType anotherInstance =
        Jsonization.Deserialize.deserializeLangStringTextType(jsonObject);
    final JsonNode anotherJsonObject = Jsonization.Serialize.toJsonObject(anotherInstance);
    assertEquals(
        mapper.readTree(jsonObject.toString()), mapper.readTree(anotherJsonObject.toString()));
  ...
  public void testRoundTripEmbeddedDataSpecification() throws IOException {
    ...
    final EmbeddedDataSpecification anotherInstance =
        Jsonization.Deserialize.deserializeEmbeddedDataSpecification(jsonObject);
    final JsonNode anotherJsonObject = Jsonization.Serialize.toJsonObject(anotherInstance);
    assertEquals(
        mapper.readTree(jsonObject.toString()), mapper.readTree(anotherJsonObject.toString()));
  ...
  public void testRoundTripValueReferencePair() throws IOException {
    ...
    final ValueReferencePair anotherInstance =
        Jsonization.Deserialize.deserializeValueReferencePair(jsonObject);
    final JsonNode anotherJsonObject = Jsonization.Serialize.toJsonObject(anotherInstance);
    assertEquals(
        mapper.readTree(jsonObject.toString()), mapper.readTree(anotherJsonObject.toString()));
  ...
  public void testRoundTripLangStringPreferredNameTypeIec61360() throws IOException {
    ...
    final LangStringPreferredNameTypeIec61360 anotherInstance =
        Jsonization.Deserialize.deserializeLangStringPreferredNameTypeIec61360(jsonObject);
    final JsonNode anotherJsonObject = Jsonization.Serialize.toJsonObject(anotherInstance);
    assertEquals(
        mapper.readTree(jsonObject.toString()), mapper.readTree(anotherJsonObject.toString()));
  ...
  public void testRoundTripLangStringShortNameTypeIec61360() throws IOException {
    ...
    final LangStringShortNameTypeIec61360 anotherInstance =
        Jsonization.Deserialize.deserializeLangStringShortNameTypeIec61360(jsonObject);
    final JsonNode anotherJsonObject = Jsonization.Serialize.toJsonObject(anotherInstance);
    assertEquals(
        mapper.readTree(jsonObject.toString()), mapper.readTree(anotherJsonObject.toString()));
  ...
  public void testRoundTripLangStringDefinitionTypeIec61360() throws IOException {
    ...
    final LangStringDefinitionTypeIec61360 anotherInstance =
        Jsonization.Deserialize.deserializeLangStringDefinitionTypeIec61360(jsonObject);
    final JsonNode anotherJsonObject = Jsonization.Serialize.toJsonObject(anotherInstance);
    assertEquals(
        mapper.readTree(jsonObject.toString()), mapper.readTree(anotherJsonObject.toString()));
  ...
  public void testRoundTripDataSpecificationIec61360() throws IOException {
    ...
    final DataSpecificationIec61360 anotherInstance =
        Jsonization.Deserialize.deserializeDataSpecificationIec61360(jsonObject);
    final JsonNode anotherJsonObject = Jsonization.Serialize.toJsonObject(anotherInstance);
    assertEquals(
        mapper.readTree(jsonObject.toString()), mapper.readTree(anotherJsonObject.toString()));
